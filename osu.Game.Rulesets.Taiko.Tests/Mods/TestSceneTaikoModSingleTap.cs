...
namespace osu.Game.Rulesets.Taiko.Tests.Mods
{
    ...
    {
        [Test]
        public void TestInputAlternate() =>
            CreateModTest(
                new ModTestData
                {
                    ...
                    CreateBeatmap = () =>
                        new Beatmap
                        {
                            ...
                            {
                                new Hit { StartTime = 100, Type = HitType.Rim },
                                new Hit { StartTime = 300, Type = HitType.Rim },
                                new Hit { StartTime = 500, Type = HitType.Rim },
                                new Hit { StartTime = 700, Type = HitType.Rim },
                            },
                        },
                    ...
                    PassCondition = () =>
                        ...
                        && Player.ScoreProcessor.HighestCombo.Value == 1,
                }
            );

        [Test]
        public void TestInputSameKey() =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new TaikoModSingleTap(),
        ...
        public void TestInputStrong() =>
            CreateModTest(
                new ModTestData
                {
                    ...
                    PassCondition = () =>
                        Player.ScoreProcessor.Combo.Value == 0
                        && Player.ScoreProcessor.HighestCombo.Value == 2,
                }
            );

        [Test]
        public void TestInputBreaks() =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new TaikoModSingleTap(),
                    ...
                    CreateBeatmap = () =>
                        new Beatmap
                        {
                            Breaks = { new BreakPeriod(100, 1600) },
                            HitObjects = new List<HitObject>
                            {
                                new Hit { StartTime = 100, Type = HitType.Rim },
                                new Hit { StartTime = 2000, Type = HitType.Rim },
                            },
                        },
                    ReplayFrames = new List<ReplayFrame>
                    {
