    ...
    public partial class TestSceneTaikoModSimplifiedRhythm : TaikoModTestScene
    {
        ...
        public void TestOneThirdConversion()
        {
            CreateModTest(
                new ModTestData
                {
                    Mod = new TaikoModSimplifiedRhythm { OneThirdConversion = { Value = true } },
                    Autoplay = false,
                    CreateBeatmap = () =>
                        new Beatmap
                        {
                    ...
                    PassCondition = () =>
                        Player.ScoreProcessor.Combo.Value == 6
        ...
        [Test]
        public void TestOneSixthConversion() =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new TaikoModSimplifiedRhythm { OneSixthConversion = { Value = true } },
                    Autoplay = false,
                    CreateBeatmap = () =>
                        new Beatmap
                        {
        ...
        [Test]
        public void TestOneEighthConversion() =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new TaikoModSimplifiedRhythm { OneEighthConversion = { Value = true } },
                    Autoplay = false,
                    CreateBeatmap = () =>
                    {
                        ...
                        return new Beatmap
                        {
                            HitObjects = new List<HitObject>
                            {
                                ...
                                new Hit
                                {
                                    StartTime = 1500 + one_eighth_timing * 1,
                                    Type = HitType.Rim,
                                }, // mod removes this
                                ...
                                new Hit
                                {
                                    StartTime = 2000 + one_eighth_timing * 1,
                                    Type = HitType.Centre,
                                }, // mod removes this
                                new Hit
                                {
                                    StartTime = 2000 + one_eighth_timing * 2,
                                    Type = HitType.Centre,
                                },
                                new Hit
                                {
                                    StartTime = 2000 + one_eighth_timing * 3,
                                    Type = HitType.Centre,
                                }, // mod removes this
                                new Hit
                                {
                                    StartTime = 2000 + one_eighth_timing * 4,
                                    Type = HitType.Centre,
                                },
                                new Hit
                                {
                                    StartTime = 2000 + one_eighth_timing * 5,
                                    Type = HitType.Centre,
                                }, // mod removes this
                                new Hit
                                {
                                    StartTime = 2000 + one_eighth_timing * 6,
                                    Type = HitType.Centre,
                                },
                                new Hit
                                {
                                    StartTime = 2000 + one_eighth_timing * 7,
                                    Type = HitType.Centre,
                                }, // mod removes this
                            },
                        };
                    ...
                    PassCondition = () =>
                        Player.ScoreProcessor.Combo.Value == 8
                        && Player.ScoreProcessor.Accuracy.Value == 1,
                }
            );
        ...
        public void TestOnlyOneThirdConversion()
        {
            CreateModTest(
                new ModTestData
                {
                    ...
                    PassCondition = () =>
                        Player.ScoreProcessor.Combo.Value == 4
                        && Player.ScoreProcessor.Accuracy.Value == 1,
                }
            );
        }
        ...
        /// </summary>
        [Test]
        public void TestOnlyOneSixthConversion() =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new TaikoModSimplifiedRhythm { OneSixthConversion = { Value = true } },
