            ...
            AddStep(
                ...
                () =>
                    SetContents(_ => new Container
                    {
                        ...
                        Child = new TaikoPlayfieldAdjustmentContainer
                        {
                            Child = new TaikoPlayfield(),
                        },
                    })
            );
        }
        ...
        public void TestHeightChanges()
        {
            ...
            AddRepeatStep(
                ...
                () =>
                {
                    ...
                    this.ChildrenOfType<TaikoPlayfieldAdjustmentContainer>()
                        .ForEach(p =>
                        {
            ...
            AddStep(
                ...
                () =>
                {
                    Beatmap.Value.Beatmap.ControlPointInfo.Add(
                        0,
                        new EffectControlPoint { KiaiMode = (kiai = !kiai) }
                    );
                }
            );
        }
