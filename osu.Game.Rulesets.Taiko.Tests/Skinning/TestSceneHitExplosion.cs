...
namespace osu.Game.Rulesets.Taiko.Tests.Skinning
{
    ...
    public partial class TestSceneHitExplosion : TaikoSkinnableTestScene
    {
        ...
        public void TestStrongHit(HitResult type)
        {
            ...
            AddStep(
                "visualise second hit",
                () =>
                    this.ChildrenOfType<HitExplosion>()
                        .ForEach(e =>
                            e.VisualiseSecondHit(
                                new JudgementResult(
            ...
            return new Container
            {
                ...
                Children = new Drawable[]
                {
                    ...
                    new AspectContainer
                    {
                        ...
                        Child = new HitExplosion(hit.Type)
                        {
                            Anchor = Anchor.Centre,
                            Origin = Anchor.Centre,
        ...
        private DrawableTestHit createHit(HitResult type) =>
            new DrawableTestHit(new Hit { StartTime = Time.Current }, type);

        private DrawableTestHit createStrongHit(HitResult type) =>
            new DrawableTestStrongHit(Time.Current, type);
    }
}
