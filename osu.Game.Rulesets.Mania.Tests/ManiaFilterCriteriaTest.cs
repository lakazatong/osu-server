...
namespace osu.Game.Rulesets.Mania.Tests
{
    ...
    public class ManiaFilterCriteriaTest
    {
        ...
        public void TestKeysEqualSingleValue()
        {
            ...
            Assert.True(
                criteria.Matches(
                    new BeatmapInfo(
                        ...
                        new BeatmapDifficulty { CircleSize = 1 }
                    ),
                    new FilterCriteria()
                )
            );
            ...
            Assert.False(
                criteria.Matches(
                    new BeatmapInfo(
                        new ManiaRuleset().RulesetInfo,
                        new BeatmapDifficulty { CircleSize = 3 }
                    ),
                    new FilterCriteria()
                )
            );
            ...
            Assert.True(
                criteria.Matches(
                    new BeatmapInfo(
                        ...
                        new BeatmapDifficulty { CircleSize = 4 }
                    ),
                    new FilterCriteria { Mods = [new ManiaModKey1()] }
                )
            );
        }
        ...
        public void TestKeysGreaterOrEqualThan()
        {
            ...
            Assert.True(
                criteria.Matches(
                    new BeatmapInfo(
                        new ManiaRuleset().RulesetInfo,
                        new BeatmapDifficulty { CircleSize = 5 }
                    ),
                    new FilterCriteria()
                )
            );
            ...
            Assert.True(
                criteria.Matches(
                    ...
                    new FilterCriteria { Mods = [new ManiaModKey7()] }
                )
            );
        }
        ...
        public void TestFilterIntersection()
        {
            ...
            Assert.True(
                criteria.Matches(
                    new BeatmapInfo(
                        new ManiaRuleset().RulesetInfo,
                        new BeatmapDifficulty { CircleSize = 9 }
                    ),
                    new FilterCriteria()
                )
            );
        ...
        public void TestInvalidFilters()
        {
            ...
            Assert.False(
                criteria.TryParseCustomKeywordCriteria("keys", Operator.Equal, "some text")
            );
            Assert.False(
                criteria.TryParseCustomKeywordCriteria("keys", Operator.NotEqual, "4,some text")
            );
            Assert.False(
                criteria.TryParseCustomKeywordCriteria("keys", Operator.GreaterOrEqual, "4,5,6")
            );
        }
    }
}
