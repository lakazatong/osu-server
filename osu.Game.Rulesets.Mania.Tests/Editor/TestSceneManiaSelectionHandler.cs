...
namespace osu.Game.Rulesets.Mania.Tests.Editor
{
    public partial class TestSceneManiaSelectionHandler : EditorTestScene
    {
        ...
        public void TestHorizontalFlipOverSelection()
        {
            ...
            AddStep(
                "flip horizontally over selection",
                () =>
                {
        ...
        public void TestOffScreenObjectsRemainSelectedOnColumnChange()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        this.ChildrenOfType<NoteSelectionBlueprint>()
                            .Single(blueprint =>
                                blueprint.IsSelected && blueprint.HitObject.StartTime == 0
                            )
                    );
            ...
            AddAssert(
                ...
                () => EditorBeatmap.HitObjects.All(ho => ((ManiaHitObject)ho).Column == 3)
            );
            AddAssert(
                "all objects remain selected",
                () => EditorBeatmap.SelectedHitObjects.SequenceEqual(EditorBeatmap.HitObjects)
            );
        }
        ...
        public void TestOffScreenObjectsRemainSelectedOnVerticalFlip()
        {
            ...
            AddAssert(
                "all objects remain selected",
                () =>
                    EditorBeatmap.SelectedHitObjects.SequenceEqual(
                        EditorBeatmap.HitObjects.Reverse()
                    )
            );
        }
    }
