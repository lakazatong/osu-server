    ...
    public partial class TestSceneManiaHitObjectComposer : EditorClockTestScene
    {
        ...
        public void TestDragOffscreenSelectionVerticallyUpScroll()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    lastObject = this.ChildrenOfType<DrawableHitObject>()
                        .Single(d => d.HitObject == composer.EditorBeatmap.HitObjects.Last());
            ...
            AddStep(
                "select all objects",
                () =>
                    composer.EditorBeatmap.SelectedHitObjects.AddRange(
                        composer.EditorBeatmap.HitObjects
                    )
            );
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        lastObject,
                        new Vector2(0, lastObject.ScreenSpaceDrawQuad.Height * 4)
                    );
            ...
            AddAssert(
                "hitobjects not moved columns",
                () => composer.EditorBeatmap.HitObjects.All(h => ((ManiaHitObject)h).Column == 0)
            );
            AddAssert(
                "hitobjects moved downwards",
                () => lastObject.DrawPosition.Y - originalPosition.Y > 0
            );
            AddAssert(
                "hitobject has moved time",
                () => lastObject.HitObject.StartTime == originalTime + 125
            );
        }
        ...
        public void TestDragOffscreenSelectionVerticallyDownScroll()
        {
            ...
            AddAssert(
                "hitobjects moved upwards",
                () => originalPosition.Y - lastObject.DrawPosition.Y > 0
            );
            AddAssert(
                "hitobject has moved time",
                () => lastObject.HitObject.StartTime == originalTime + 125
        ...
        public void TestDragOffscreenSelectionHorizontally()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    InputManager.MoveMouseTo(
                        lastObject,
                        new Vector2(
                            secondColumn.ScreenSpaceDrawQuad.Centre.X
                                - firstColumn.ScreenSpaceDrawQuad.Centre.X
                                + 1,
                            0
                        )
                    );
            ...
            AddAssert(
                "hitobjects moved columns",
                () => composer.EditorBeatmap.HitObjects.All(h => ((ManiaHitObject)h).Column == 1)
            );
            ...
            AddAssert(
                "hitobjects not moved vertically",
                () => lastObject.DrawPosition.Y - originalPosition.Y <= DefaultNotePiece.NOTE_HEIGHT
            );
        }
        ...
        public void TestDragHoldNoteSelectionVertically()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    composer.EditorBeatmap.Add(new HoldNote { Column = 1, EndTime = 200 });
                }
            );
            ...
            AddAssert(
                "head note positioned correctly",
                () =>
                    Precision.AlmostEquals(
                        holdNote.ScreenSpaceDrawQuad.BottomLeft,
                        holdNote.Head.ScreenSpaceDrawQuad.BottomLeft
                    )
            );
            AddAssert(
                "tail note positioned correctly",
                () =>
                    Precision.AlmostEquals(
                        holdNote.ScreenSpaceDrawQuad.TopLeft,
                        holdNote.Tail.ScreenSpaceDrawQuad.BottomLeft
                    )
            );

            AddAssert(
                "head blueprint positioned correctly",
                () =>
                    this.ChildrenOfType<EditHoldNoteEndPiece>().ElementAt(0).DrawPosition
                    == holdNote.Head.DrawPosition
            );
            AddAssert(
                "tail blueprint positioned correctly",
                () =>
                    this.ChildrenOfType<EditHoldNoteEndPiece>().ElementAt(1).DrawPosition
                    == holdNote.Tail.DrawPosition
            );
        }
        ...
        public void TestDragHoldNoteHead()
        {
            ...
            AddAssert(
                ...
                () =>
                    Precision.AlmostEquals(
                        drawableHoldNote.ScreenSpaceDrawQuad.BottomLeft,
                        drawableHoldNote.Head.ScreenSpaceDrawQuad.BottomLeft
                    )
            );
            AddAssert(
                "tail note positioned correctly",
                () =>
                    Precision.AlmostEquals(
                        drawableHoldNote.ScreenSpaceDrawQuad.TopLeft,
                        drawableHoldNote.Tail.ScreenSpaceDrawQuad.BottomLeft
                    )
            );
            ...
            AddAssert(
                ...
                () =>
                    this.ChildrenOfType<EditHoldNoteEndPiece>().ElementAt(0).DrawPosition
                    == drawableHoldNote.Head.DrawPosition
            );
            AddAssert(
                "tail blueprint positioned correctly",
                () =>
                    this.ChildrenOfType<EditHoldNoteEndPiece>().ElementAt(1).DrawPosition
                    == drawableHoldNote.Tail.DrawPosition
            );
        }
        ...
        private void setScrollStep(ScrollingDirection direction) =>
            AddStep(
                $"set scroll direction = {direction}",
                () =>
                    (
                        (Bindable<ScrollingDirection>)composer.Composer.ScrollingInfo.Direction
                    ).Value = direction
            );
