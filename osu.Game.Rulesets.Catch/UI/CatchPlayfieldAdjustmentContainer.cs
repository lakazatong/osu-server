    ...
    public partial class CatchPlayfieldAdjustmentContainer : PlayfieldAdjustmentContainer
    {
            ...
            InternalChild = scaleContainer = new Container
            {
                ...
                Child = new Container
                {
                    ...
                    Child = new Container
                    {
                        ...
                        Size =
                            new Vector2(base_game_width, base_game_height) * playfield_size_adjust,
        ...
        private void load(OsuGame? osuGame)
        {
            if (osuGame != null)
            {
                ...
                float aspectRatio =
                    osuGame.ScalingContainerTargetDrawSize.X
                    / osuGame.ScalingContainerTargetDrawSize.Y;
        ...
        private partial class ScalingContainer : Container
        {
            ...
            protected override void Update()
            {
                ...
                const float playfield_v_size_adjustment =
                    (stable_catcher_y_position - stable_fruit_start_position)
                    / CatchPlayfield.HEIGHT;
                const float playfield_v_catcher_offset =
                    stable_catcher_y_position - CatchPlayfield.HEIGHT;
