...
namespace osu.Game.Rulesets.Catch.Tests.Editor
{
    ...
    public partial class TestSceneCatchReverseSelection : TestSceneEditor
    {
        ...
        public void TestReverseSelectionTwoFruits()
        {
            ...
            addObjects(
                [new Fruit { StartTime = 200, X = 0 }, new Fruit { StartTime = 400, X = 20 }]
            );
        ...
        public void TestReverseSelectionThreeFruits()
        {
            ...
            addObjects(
                [
                    new Fruit { StartTime = 200, X = 0 },
                    new Fruit { StartTime = 400, X = 20 },
                    new Fruit { StartTime = 600, X = 40 },
                ]
            );
        ...
        public void TestReverseSelectionTwoCombos()
        {
            ...
            addObjects(
                [
                    ...
                    new Fruit { StartTime = 1000, X = 80 },
                    new Fruit { StartTime = 1200, X = 100 },
                ]
            );
        ...
        private void addObjects(CatchHitObject[] hitObjects) =>
            AddStep("Add objects", () => EditorBeatmap.AddRange(hitObjects));

        private IEnumerable<CatchHitObject> getObjects() =>
            EditorBeatmap.HitObjects.OfType<CatchHitObject>();
