...
namespace osu.Game.Tests.OnlinePlay
{
    ...
    public partial class TestSceneOnlinePlaySubScreenStack : OnlinePlayTestScene
    {
        ...
        public void Setup() =>
            Schedule(() =>
            {
                Child = stack = new OnlinePlaySubScreenStack { RelativeSizeAxes = Axes.Both };
            });
        ...
        {
            AddAssert(
                "bindables not disabled",
                () => Beatmap.Disabled || Ruleset.Disabled || SelectedMods.Disabled,
                () => Is.False
            );

            AddStep(
                "push screen that disables bindables",
                () => stack.Push(new ScreenWithExternalBindableDisablement(true))
            );
            AddAssert(
                "bindables disabled",
                () => Beatmap.Disabled && Ruleset.Disabled && SelectedMods.Disabled,
            ...
            AddStep(
                "push screen that does not disable bindables",
                () => stack.Push(new ScreenWithExternalBindableDisablement(false))
            );
            AddAssert(
                "bindables not disabled",
                () => Beatmap.Disabled || Ruleset.Disabled || SelectedMods.Disabled,
        ...
        public void TestModsResetWhenExitToLounge()
        {
            ...
            AddStep(
                "push screen with mod",
                () => stack.Push(new ScreenWithMod(new OsuModDoubleTime()))
            );
            AddUntilStep(
                "wait for screen to load",
                () => ((OsuScreen)stack.CurrentScreen).IsLoaded
            );
