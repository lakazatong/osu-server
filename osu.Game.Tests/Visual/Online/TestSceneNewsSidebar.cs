...
namespace osu.Game.Tests.Visual.Online
{
    public partial class TestSceneNewsSidebar : OsuTestScene
    {
        ...
        [SetUp]
        public void SetUp() =>
            Schedule(() => Child = sidebar = new TestNewsSidebar { YearChanged = onYearChanged });
        ...
        public void TestBasic()
        {
            ...
            AddUntilStep(
                "Month sections exist",
                () => sidebar.ChildrenOfType<MonthSection>().Any()
            );
        }
        ...
        {
            AddStep(
                "Add data with no posts",
                () => sidebar.Metadata.Value = metadata_with_no_posts
            );
            AddUntilStep(
                "No month sections were created",
                () => !sidebar.ChildrenOfType<MonthSection>().Any()
            );
        }
        ...
        public void TestMetadataWithMultipleYears()
        {
            AddStep(
                ...
                () => sidebar.Metadata.Value = metadata_with_multiple_years
            );
            AddUntilStep(
                "2022 month sections exist",
                () => sidebar.ChildrenOfType<MonthSection>().Any(s => s.Year == 2022)
            );
            AddUntilStep(
                "2021 month sections exist",
                () => sidebar.ChildrenOfType<MonthSection>().Any(s => s.Year == 2021)
            );
        }
        ...
        private APINewsSidebar getMetadata(int year) =>
            new APINewsSidebar
            {
                CurrentYear = year,
                Years = new[] { 2021, 2020, 2019, 2018, 2017, 2016, 2015, 2014, 2013 },
                NewsPosts = new List<APINewsPost>
                {
                    ...
                    {
                        Title =
                            "(Mar) Oh boy that's a long post title I wonder if it will break anything",
                        PublishedAt = new DateTime(year, 3, 1),
                    },
                    new APINewsPost
                    {
                    ...
                    {
                        Title =
                            "(Feb) Oh boy that's a long post title I wonder if it will break anything",
                        PublishedAt = new DateTime(year, 2, 1),
                    },
                    new APINewsPost
                    {
                    ...
                    {
                        Title =
                            "Oh boy that's a long post title I wonder if it will break anything",
                        PublishedAt = new DateTime(year, 1, 1),
                    },
                    new APINewsPost
                    {
        ...
        {
            CurrentYear = 2022,
            Years = new[] { 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015, 2014, 2013 },
            NewsPosts = new List<APINewsPost>
            {
                new APINewsPost
                {
                ...
                {
                    Title =
                        "(Mar 2022) Oh boy that's a long post title I wonder if it will break anything",
                    PublishedAt = new DateTime(2022, 3, 1),
                },
                new APINewsPost
                {
                ...
                {
                    Title =
                        "(Jan 2022) Oh boy that's a long post title I wonder if it will break anything",
