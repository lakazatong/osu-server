    ...
    public partial class TestScenePlayHistorySubsection : OsuTestScene
    {
        ...
        public void TestNullValues()
        {
            AddStep(
                "Load user",
                () =>
                    user.Value = new UserProfileData(
                        user_with_null_values,
        ...
        public void TestFilledValues()
        {
            ...
            AddAssert(
                ...
                () => user_with_filled_values.MonthlyPlayCounts.Length == getChartValuesLength()
            );
        }
        ...
        private int getChartValuesLength() =>
            this.ChildrenOfType<ProfileLineChart>().Single().Values.Length;

        private static readonly APIUser user_with_null_values = new APIUser { Id = 1 };
