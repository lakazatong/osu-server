...
namespace osu.Game.Tests.Visual.Online
{
    public partial class TestSceneNewsOverlay : OsuTestScene
    {
        ...
        private ShowMoreButton showMoreButton =>
            overlay.ChildrenOfType<ShowMoreButton>().FirstOrDefault();
        ...
        private static GetNewsResponse responseExample =>
            new GetNewsResponse
            {
                NewsPosts = new[]
                {
        ...
        private static GetNewsResponse responseWithCursor =>
            new GetNewsResponse
            {
                NewsPosts = new[]
                {
        ...
        private static GetNewsResponse responseWithNoCursor =>
            new GetNewsResponse
            {
                NewsPosts = new[]
                {
