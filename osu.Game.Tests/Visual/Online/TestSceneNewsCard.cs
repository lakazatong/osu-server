...
namespace osu.Game.Tests.Visual.Online
{
    public partial class TestSceneNewsCard : OsuTestScene
    {
        ...
        {
            Add(
                new FillFlowContainer<NewsCard>
                {
                    ...
                    Children = new[]
                    {
                        new NewsCard(
                            ...
                            {
                                Title =
                                    "This post has an image which starts with \"/\" and has many authors! (clickable)",
                                Preview =
                        ...
                        new NewsCard(
                            ...
                            {
                                Title =
                                    "This post has a full-url image! (HTML entity: &amp;) (non-clickable)",
