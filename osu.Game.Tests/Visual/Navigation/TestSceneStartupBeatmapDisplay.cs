...
namespace osu.Game.Tests.Visual.Navigation
{
    public partial class TestSceneStartupBeatmapDisplay : OsuGameTestScene
    {
        ...
        protected override TestOsuGame CreateTestGame() =>
            new TestOsuGame(LocalStorage, API, new[] { $"osu://b/{requested_beatmap_id}" });
        ...
        public void TestBeatmapLink()
        {
            ...
            AddUntilStep(
                ...
                () =>
                    Game.ChildrenOfType<BeatmapPicker>().FirstOrDefault()?.Beatmap.Value?.OnlineID
                    == requested_beatmap_id
            );
        }
    }
}
