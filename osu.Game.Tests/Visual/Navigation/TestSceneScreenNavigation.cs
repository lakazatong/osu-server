...
namespace osu.Game.Tests.Visual.Navigation
{
    public partial class TestSceneScreenNavigation : OsuGameTestScene
    {
        ...
        private Vector2 backButtonPosition =>
            Game.ToScreenSpace(
                new Vector2(click_padding, Game.LayoutRectangle.Bottom - click_padding)
            );

        private Vector2 optionsButtonPosition =>
            Game.ToScreenSpace(new Vector2(click_padding, click_padding));
        ...
        public void TestConfirmationRequiredToDiscardPlaylist(bool withPlaylistItemAdded)
        {
            ...
            AddUntilStep(
                ...
                () => Game.ChildrenOfType<DialogOverlay>().SingleOrDefault() != null
            );
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        playlistScreen.ChildrenOfType<CreatePlaylistsRoomButton>().Single()
                    );
            ...
            {
                AddUntilStep(
                    "wait for settings displayed",
                    () =>
                        (playlistScreen.CurrentSubScreen as PlaylistsRoomSubScreen)
                            ?.ChildrenOfType<PlaylistsRoomSettingsOverlay>()
                            .SingleOrDefault()
                ...
                AddUntilStep(
                    ...
                    () =>
                        (playlistScreen.CurrentSubScreen as PlaylistsSongSelect)?.BeatmapSetsLoaded
                        == true
                );
                ...
                AddUntilStep(
                    "wait for return to playlist screen",
                    () => playlistScreen.CurrentSubScreen is PlaylistsRoomSubScreen
                );
                ...
                AddStep(
                    ...
                    () =>
                    {
                        InputManager.MoveMouseTo(
                            playlistScreen
                                .ChildrenOfType<PurpleRoundedButton>()
                ...
                AddStep(
                    ...
                    {
                        InputManager.MoveMouseTo(
                            Game.Toolbar.ChildrenOfType<ToolbarHomeButton>().Single()
                        );
                        InputManager.Click(MouseButton.Left);
                    }
                );
                ...
                AddAssert(
                    ...
                    () => Game.ChildrenOfType<DialogOverlay>().Single().CurrentDialog is not null
                );
                ...
                AddAssert(
                    "dialog dismissed",
                    () => Game.ChildrenOfType<DialogOverlay>().Single().CurrentDialog == null
                );
        ...
        public void TestExitSongSelectWithEscape()
        {
            ...
            AddAssert(
                "Overlay was shown",
                () => songSelect.ModSelectOverlay.State.Value == Visibility.Visible
            );
            pushEscape();
            AddAssert(
                "Overlay was hidden",
                () => songSelect.ModSelectOverlay.State.Value == Visibility.Hidden
            );
            exitViaEscapeAndConfirm();
        }
        ...
        public void TestSongSelectBackActionHandling()
        {
            ...
            AddAssert(
                "filter cleared",
                () => string.IsNullOrEmpty(filterControlTextBox().Current.Value)
            );
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        songSelect.ChildrenOfType<CollectionDropdown>().Single()
                    );
                    InputManager.Click(MouseButton.Left);
                }
            );
            ...
            AddAssert(
                ...
                () =>
                    songSelect
                        .ChildrenOfType<CollectionDropdown>()
                        .Single()
                        .ChildrenOfType<Dropdown<CollectionFilterMenuItem>.DropdownMenu>()
                        .Single()
            ...
            TextBox filterControlTextBox() =>
                songSelect.ChildrenOfType<FilterControl.FilterControlTextBox>().Single();
        }
        ...
        public void TestSongSelectRandomRewindButton()
        {
            ...
            AddUntilStep(
                "wait for selection changed",
                () => Game.Beatmap.Value.BeatmapInfo.ID,
                () => Is.Not.EqualTo(originalSelection)
            );

            AddStep("hit random rewind", () => InputManager.Click(MouseButton.Right));
            AddUntilStep(
                "wait for selection reverted",
                () => Game.Beatmap.Value.BeatmapInfo.ID,
                () => Is.EqualTo(originalSelection)
            );
        }
        ...
        public void TestSongSelectScrollHandling()
        {
            ...
            AddStep(
                "set game volume to max",
                () =>
                    Game
                        .Dependencies.Get<FrameworkConfigManager>()
                        .SetValue(FrameworkSetting.VolumeUniversal, 1d)
            );
            AddUntilStep(
                "wait for volume overlay to hide",
                () => Game.ChildrenOfType<VolumeOverlay>().SingleOrDefault()?.State.Value,
            ...
            AddStep(
                ...
                () =>
                    InputManager.MoveMouseTo(
                        songSelect
                            .ChildrenOfType<Screens.Select.SongSelect.LeftSideInteractionContainer>()
                            .Single()
                            .ScreenSpaceDrawQuad.TopLeft + new Vector2(1)
                    )
            );
            AddStep("scroll down", () => InputManager.ScrollVerticalBy(-1));
            AddAssert(
                "carousel didn't move",
            ...
            AddAssert(
                "game volume decreased",
                () =>
                    Game
                        .Dependencies.Get<FrameworkConfigManager>()
                        .Get<double>(FrameworkSetting.VolumeUniversal),
                () => Is.LessThan(1)
            );
            ...
            AddStep(
                "move to carousel",
                () =>
                    InputManager.MoveMouseTo(songSelect.ChildrenOfType<BeatmapCarousel>().Single())
            );
            AddStep("scroll down", () => InputManager.ScrollVerticalBy(-1));
            AddAssert(
                "carousel moved",
                getCarouselScrollPosition,
                () => Is.Not.EqualTo(scrollPosition)
            );

            double getCarouselScrollPosition() =>
                Game.ChildrenOfType<UserTrackingScrollContainer<DrawableCarouselItem>>()
                    .Single()
                    .Current;
        }
        ...
        public void TestNewSongSelectScrollHandling()
        {
            ...
            AddStep(
                ...
                () =>
                    InputManager.MoveMouseTo(
                        songSelect.ChildrenOfType<Screens.SelectV2.BeatmapCarousel>().Single()
                    )
            );
            AddStep("scroll down", () => InputManager.ScrollVerticalBy(-1));
            AddAssert(
            ...
            double getCarouselScrollPosition() =>
                Game.ChildrenOfType<Carousel<BeatmapInfo>>()
                    .Single()
        ...
        public void TestAttemptPlayBeatmapWrongHashFails()
        {
            ...
            AddStep(
                "import beatmap",
                () => BeatmapImportHelper.LoadQuickOszIntoOsu(Game).GetResultSafely()
            );
            PushAndConfirm(() => songSelect = new TestPlaySongSelect());
            AddUntilStep("wait for song select", () => songSelect.BeatmapSetsLoaded);
            ...
            AddStep(
                "change beatmap files",
                () =>
                {
                    FileUtils.AttemptOperation(() =>
                    {
                        foreach (
                            var file in Game.Beatmap.Value.BeatmapSetInfo.Files.Where(f =>
                                Path.GetExtension(f.Filename) == ".osu"
                            )
                        )
                        {
                            using (
                                var stream = Game.Storage.GetStream(
                                    Path.Combine("files", file.File.GetStoragePath()),
            ...
            AddStep(
                ...
                () =>
                {
                    ((IWorkingBeatmapCache)Game.BeatmapManager).Invalidate(
                        Game.Beatmap.Value.BeatmapSetInfo
                    );
                }
            );
        ...
        public void TestOffsetAdjustDuringPause()
        {
            ...
            AddUntilStep(
                "wait for pause",
                () => player.ChildrenOfType<GameplayClockContainer>().First().IsPaused.Value,
                () => Is.True
            );
            ...
            {
                AddUntilStep(
                    $"control offset is {offset}",
                    () =>
                        this.ChildrenOfType<GameplayOffsetControl>()
                            .Single()
                            .ChildrenOfType<BeatmapOffsetControl>()
                            .Single()
                            .Current.Value,
                    () => Is.EqualTo(offset)
                );
                AddUntilStep(
                    $"database offset is {offset}",
                    () =>
                        Game
                            .BeatmapManager.QueryBeatmap(b =>
                                b.ID == Game.Beatmap.Value.BeatmapInfo.ID
                            )!
                            .UserSettings.Offset,
                    () => Is.EqualTo(offset)
                );
        ...
        public void TestScrollSpeedAdjustDuringGameplay()
        {
            ...
            AddStep(
                ...
                () => player.ChildrenOfType<GameplayClockContainer>().First().Seek(10500)
            );
            AddUntilStep(
                "wait for seek",
                () => player.ChildrenOfType<GameplayClockContainer>().First().CurrentTime,
                () => Is.GreaterThan(10600)
            );
            AddStep("attempt adjust offset via keyboard", () => InputManager.Key(Key.F4));
            checkScrollSpeed(9, 9);

            AddStep(
                "attempt adjust offset via config change",
                () => getConfigManager().SetValue(ManiaRulesetSetting.ScrollSpeed, 10.0)
            );
            ...
            {
                AddUntilStep(
                    $"config value is {configValue}",
                    () => getConfigManager().Get<double>(ManiaRulesetSetting.ScrollSpeed),
                    () => Is.EqualTo(configValue)
                );
                AddUntilStep(
                    $"gameplay value is {gameplayValue}",
                    () => this.ChildrenOfType<DrawableManiaRuleset>().Single().TargetTimeRange,
                    () => Is.EqualTo(DrawableManiaRuleset.ComputeScrollTime(gameplayValue))
                );
            }

            ManiaRulesetConfigManager getConfigManager() =>
                (
                    (ManiaRulesetConfigManager)
                        Game
                            .Dependencies.Get<IRulesetConfigCache>()
                            .GetConfigFor(new ManiaRuleset())!
                );
        }
        ...
        public void TestRetryCountIncrements()
        {
            ...
            AddStep(
                "end spectator before retry",
                () => Game.SpectatorClient.EndPlaying(player.GameplayState)
            );

            AddStep(
                "attempt to retry",
                () => player.ChildrenOfType<HotkeyRetryOverlay>().First().Action()
            );
            AddAssert(
                "old player score marked failed",
                () => player.Score.ScoreInfo.Rank,
                () => Is.EqualTo(ScoreRank.F)
            );
            AddUntilStep(
                "wait for old player gone",
                () => Game.ScreenStack.CurrentScreen != player
            );

            AddUntilStep(
                "get new player",
                () => (player = Game.ScreenStack.CurrentScreen as Player) != null
            );
        ...
        public void TestLastScoreNotNullAfterExitingPlayer()
        {
            ...
            AddStep(
                "attempt to retry",
                () => getOriginalPlayer().ChildrenOfType<HotkeyRetryOverlay>().First().Action()
            );
            AddUntilStep(
                "last play matches player",
                getLastPlay,
                () => Is.EqualTo(getOriginalPlayer().Score.ScoreInfo)
            );

            AddUntilStep(
                "wait for player",
                () =>
                    Game.ScreenStack.CurrentScreen != getOriginalPlayer()
            ...
            ScoreInfo getLastPlay() =>
                Game.Dependencies.Get<SessionStatics>().Get<ScoreInfo>(Static.LastLocalUserScore);
        }
        ...
        public void TestRetryImmediatelyAfterCompletion()
        {
            ...
            AddAssert(
                "original play isn't failed",
                () => getOriginalPlayer().Score.ScoreInfo.Rank,
        ...
        public void TestExitImmediatelyAfterCompletion()
        {
            ...
            AddStep(
                "attempt to exit",
                () => player().ChildrenOfType<HotkeyExitOverlay>().First().Action()
            );
        ...
        public void TestShowMedalAtResults()
        {
            ...
            AddStep(
                "award medal",
                () =>
                    ((DummyAPIAccess)API).NotificationsClient.Receive(
                        new SocketMessage
                        {
                            Event = @"new",
                            Data = JObject.FromObject(
                                new NewPrivateNotificationEvent
                                {
                                    Name = @"user_achievement_unlock",
                                    Details = JObject.FromObject(
            ...
            AddUntilStep(
                "medal overlay shown",
                () => Game.ChildrenOfType<MedalOverlay>().Single().State.Value,
        ...
        public void TestRetryFromResults()
        {
            ...
            AddStep(
                "attempt to retry",
                () =>
                    ((ResultsScreen)Game.ScreenStack.CurrentScreen)
                        .ChildrenOfType<HotkeyRetryOverlay>()
                        .First()
                        .Action()
            );
            AddUntilStep(
        ...
        public void TestDeleteAllScoresAfterPlaying()
        {
            ...
            AddStep(
                "get score",
                () => score = ((ResultsScreen)Game.ScreenStack.CurrentScreen).Score
            );

            AddAssert(
                "ensure score is databased",
                () => Game.Realm.Run(r => r.Find<ScoreInfo>(score.ID)?.DeletePending == false)
            );

            AddStep(
                "press back button",
                () => Game.ChildrenOfType<BackButton>().First().Action!.Invoke()
            );

            AddStep(
                "show local scores",
                () =>
                    Game.ChildrenOfType<BeatmapDetailAreaTabControl>().First().Current.Value =
            ...
            AddUntilStep(
                "wait for score displayed",
                () =>
                    (
                        scorePanel = Game.ChildrenOfType<LeaderboardScore>()
                            .FirstOrDefault(s => s.Score.Equals(score))
                    ) != null
            );
            ...
            AddUntilStep(
                "ensure score is pending deletion",
                () => Game.Realm.Run(r => r.Find<ScoreInfo>(score.ID)?.DeletePending == true)
            );
        ...
        public void TestDeleteScoreAfterPlaying()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    var dropdownItem = Game.ChildrenOfType<PlayBeatmapDetailArea>()
                        .First()
                        .ChildrenOfType<OsuContextMenu>()
                        .First()
                        .ChildrenOfType<DrawableOsuMenuItem>()
                        .First(i => i.Item.Text.ToString() == "Delete");
        ...
        public void TestSongContinuesAfterExitPlayer(bool withUserPause)
        {
            ...
            AddAssert(
                "Ensure time before preview point",
                () =>
                    Game.MusicController.CurrentTrack.CurrentTime
                    < beatmap().BeatmapInfo.Metadata.PreviewTime
            );
            ...
            AddAssert(
                "Ensure time wasn't reset to preview point",
                () =>
                    Game.MusicController.CurrentTrack.CurrentTime
                    < beatmap().BeatmapInfo.Metadata.PreviewTime
            );
        ...
        public void TestMenuMakesMusic()
        {
            ...
            AddUntilStep(
                "wait for no track",
                () => Game.MusicController.CurrentTrack.IsDummyDevice
            );
            ...
            AddUntilStep(
                ...
                () =>
                    !Game.MusicController.CurrentTrack.IsDummyDevice
                    && Game.MusicController.IsPlaying
            );
        }
        ...
        public void TestExitSongSelectWithClick()
        {
            ...
            AddStep(
                "Move mouse to dimmed area",
                () =>
                    InputManager.MoveMouseTo(
                        new Vector2(
                            songSelect.ScreenSpaceDrawQuad.TopLeft.X + 1,
                            songSelect.ScreenSpaceDrawQuad.TopLeft.Y
                                + songSelect.ScreenSpaceDrawQuad.Height / 2
                        )
                    )
            );
        ...
        public void TestModsResetOnEnteringMultiplayer()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    Game.SelectedMods.Value = new[] { osuAutomationMod };
                }
            );
            ...
            AddUntilStep(
                "Mods are restored",
                () => Game.SelectedMods.Value.Contains(osuAutomationMod)
            );
        }
        ...
        public void TestOpenOptionsAndExitWithEscape()
        {
            ...
            AddStep(
                "Move mouse to options overlay",
                () => InputManager.MoveMouseTo(optionsButtonPosition)
            );
            AddStep("Click options overlay", () => InputManager.Click(MouseButton.Left));
            AddAssert(
                "Options overlay was opened",
                () => Game.Settings.State.Value == Visibility.Visible
            );
            AddStep("Hide options overlay using escape", () => InputManager.Key(Key.Escape));
            AddAssert(
                "Options overlay was closed",
                () => Game.Settings.State.Value == Visibility.Hidden
            );
        }
        ...
        public void TestModSelectInput()
        {
            ...
            AddAssert(
                "Ruleset changed to osu!taiko",
                () =>
                    Game.Toolbar.ChildrenOfType<ToolbarRulesetSelector>()
                        .Single()
                        .Current.Value.OnlineID == 1
            );

            AddAssert(
                "Mods overlay still visible",
                () => songSelect.ModSelectOverlay.State.Value == Visibility.Visible
            );
        }
        ...
        public void TestBeatmapOptionsInput()
        {
            ...
            AddAssert(
                "Options overlay still visible",
                () => songSelect.BeatmapOptionsOverlay.State.Value == Visibility.Visible
            );
        }
        ...
        public void TestToolbarHiddenByUser()
        {
            ...
            AddUntilStep(
                "Toolbar is visible",
                () => Game.Toolbar.State.Value == Visibility.Visible
            );
        ...
        public void TestPushMatchSubScreenAndPressBackButtonImmediately()
        {
            ...
            AddStep(
                "open room",
                () => multiplayerComponents.ChildrenOfType<LoungeSubScreen>().Single().Open()
            );
            AddStep(
                "press back button",
                () => Game.ChildrenOfType<BackButton>().First().Action!.Invoke()
            ...
            AddStep(
                "clean up multiplayer request handler",
                () => ((DummyAPIAccess)API).HandleRequest = null
            );
        }
        ...
        {
            BeatmapListingOverlay getBeatmapListingOverlay() =>
                Game.ChildrenOfType<BeatmapListingOverlay>().FirstOrDefault();
            ...
            AddUntilStep(
                "Wait for beatmap overlay to load",
                () => getBeatmapListingOverlay()?.State.Value == Visibility.Visible
            );
            AddAssert(
                "featured artist filter is on",
                () =>
                    getBeatmapListingOverlay()
                        .ChildrenOfType<BeatmapSearchGeneralFilterRow>()
                        .First()
                        .Current.Contains(SearchGeneral.FeaturedArtists)
            );
            AddStep(
                "toggle featured artist filter",
                () =>
                    getBeatmapListingOverlay()
                        .ChildrenOfType<FilterTabItem<SearchGeneral>>()
                        .First(i => i.Value == SearchGeneral.FeaturedArtists)
                        .TriggerClick()
            );
            ...
            AddAssert(
                "featured artist filter is still on",
                () =>
                    getBeatmapListingOverlay()
                        .ChildrenOfType<BeatmapSearchGeneralFilterRow>()
                        .First()
        ...
        public void TestBeatmapListingLinkSearchOnInitialOpen()
        {
            ...
            AddAssert(
                "beatmap overlay sorted by relevance",
                () =>
                    getBeatmapListingOverlay()
                        .ChildrenOfType<BeatmapListingSortTabControl>()
                        .Single()
                        .Current.Value == SortCriteria.Relevance
            );
        }
        ...
        {
            ChangelogOverlay getChangelogOverlay() =>
                Game.ChildrenOfType<ChangelogOverlay>().FirstOrDefault();
            ...
            AddUntilStep(
                "wait for notifications shown",
                () =>
                    Game.Notifications.IsPresent
                    && Game.Notifications.State.Value == Visibility.Visible
            );
            AddStep("Show changelog listing", () => Game.ShowChangelogListing());
            AddUntilStep(
                "wait for changelog shown",
                () =>
                    getChangelogOverlay()?.IsPresent == true
                    && getChangelogOverlay()?.State.Value == Visibility.Visible
            );
            AddAssert(
        ...
        public void TestMainOverlaysClosesSettingsOverlay()
        {
            ...
            AddUntilStep(
                "wait for settings shown",
                () => Game.Settings.IsPresent && Game.Settings.State.Value == Visibility.Visible
            );
            AddStep("Show changelog listing", () => Game.ShowChangelogListing());
            AddUntilStep(
                "wait for changelog shown",
        ...
        public void TestOverlayClosing()
        {
            ...
            AddUntilStep(
                "Wait for now playing load",
                () =>
                    (nowPlayingOverlay = Game.ChildrenOfType<NowPlayingOverlay>().FirstOrDefault())
                    != null
            );
            ...
            // background -> toolbar
            AddStep(
                "move cursor to background",
                () => InputManager.MoveMouseTo(Game.ScreenSpaceDrawQuad.BottomRight)
            );
            AddStep("press left mouse button", () => InputManager.PressButton(MouseButton.Left));
            AddStep(
                "move cursor to toolbar",
                () => InputManager.MoveMouseTo(Game.Toolbar.ScreenSpaceDrawQuad.Centre)
            );
            AddStep(
            ...
            AddAssert(
                ...
                () => nowPlayingOverlay.State.Value == Visibility.Hidden
            );
            ...
            AddStep("press left mouse button", () => InputManager.PressButton(MouseButton.Left));
            AddStep(
                "move cursor to now playing overlay",
                () => InputManager.MoveMouseTo(nowPlayingOverlay.ScreenSpaceDrawQuad.Centre)
            );
            AddStep(
                "release left mouse button",
                () => InputManager.ReleaseButton(MouseButton.Left)
        ...
        public void TestExitWithOperationInProgress()
        {
            ...
            AddAssert(
                ...
                () => Game.Notifications.AllNotifications.Count(),
                () => Is.EqualTo(15)
            );
            ...
            AddUntilStep(
                "confirmation dialog shown",
                () =>
                    Game.ChildrenOfType<DialogOverlay>().Single().CurrentDialog is ConfirmExitDialog
            );
            ...
            AddStep(
                ...
                () =>
                {
                    this.ChildrenOfType<ProgressNotification>()
                        .ForEach(n =>
                        {
                            n.Progress = 100;
        ...
        public void TestForceExitWithOperationInProgress()
        {
            AddStep(
                "set hold delay to 0",
                () => Game.LocalConfig.SetValue(OsuSetting.UIHoldActivationDelay, 0.0)
            );
            AddUntilStep(
                "wait for dialog overlay",
                () => Game.ChildrenOfType<DialogOverlay>().SingleOrDefault() != null
        ...
        public void TestExitWithHoldDisabled()
        {
            ...
            AddAssert(
                "exit dialog is shown",
                () => Game.Dependencies.Get<IDialogOverlay>().CurrentDialog is ConfirmExitDialog
            );
        }
        ...
        public void TestQuickSkinEditorDoesntNukeSkin()
        {
            ...
            AddUntilStep(
                "wait for gameplay still has health bar",
                () => player.ChildrenOfType<ArgonHealthDisplay>().Any()
            );
        }
        ...
        public void TestTouchScreenDetectionAtSongSelect()
        {
            ...
            AddAssert(
                "touch screen detected active",
                () => Game.Dependencies.Get<SessionStatics>().Get<bool>(Static.TouchInputActive),
                () => Is.True
            );
            ...
            AddAssert(
                "touch screen detected inactive",
                () => Game.Dependencies.Get<SessionStatics>().Get<bool>(Static.TouchInputActive),
                () => Is.False
            );
            ...
            AddUntilStep(
                ...
                () => Game.SelectedMods.Value,
                () => Has.One.InstanceOf<ModTouchDevice>()
            );
            ...
            AddUntilStep(
                ...
                () => Game.SelectedMods.Value,
                () => Has.None.InstanceOf<ModTouchDevice>()
            );
            AddStep(
                "touch beatmap wedge",
                () =>
        ...
        public void TestTouchScreenDetectionInGame()
        {
            ...
            AddStep(
                "import beatmap",
                () => beatmapSet = BeatmapImportHelper.LoadQuickOszIntoOsu(Game).GetResultSafely()
            );
            AddUntilStep(
                "wait for selected",
            ...
            AddUntilStep(
                "touch device mod added to score",
                () => player.Score.ScoreInfo.Mods,
                () => Has.One.InstanceOf<ModTouchDevice>()
            );

            AddStep("exit player", () => player.Exit());
            AddUntilStep(
                "touch device mod still active",
                () => Game.SelectedMods.Value,
                () => Has.One.InstanceOf<ModTouchDevice>()
            );
        }
        ...
        public void TestExitSongSelectAndImmediatelyClickLogo()
        {
            ...
            AddStep(
                "press escape and then click logo immediately",
                () =>
                {
                    InputManager.Key(Key.Escape);
        ...
        private Func<Player> playToResults()
        {
            ...
            AddUntilStep(
                "wait for results",
                () => (Game.ScreenStack.CurrentScreen as ResultsScreen)?.IsLoaded == true
            );
            return player;
        }
        ...
        private Func<Player> playToCompletion()
        {
            ...
            AddStep(
                "set mods",
                () =>
                    Game.SelectedMods.Value = new Mod[]
                    {
                        new OsuModNoFail(),
            ...
            AddStep(
                ...
                () =>
                    player
                        .ChildrenOfType<GameplayClockContainer>()
                        .First()
                        .Seek(beatmap().Beatmap.HitObjects[^1].StartTime - 1000)
            );
        ...
        private void pushEscape() => AddStep("Press escape", () => InputManager.Key(Key.Escape));
