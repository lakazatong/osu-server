...
namespace osu.Game.Tests.Visual.UserInterface
{
    public partial class TestSceneDeleteLocalScore : OsuManualInputManagerTestScene
    {
        ...
        public void SetupSteps()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    Realm.Run(r =>
                    {
                        ...
                        scoreManager.Undelete(
                            r.All<ScoreInfo>().Where(s => s.DeletePending).ToList()
                        );
                    });
                }
            );
            ...
            AddUntilStep(
                "wait for drawables",
                () => leaderboard.ChildrenOfType<LeaderboardScore>().Any()
            );
        }
        ...
        public void TestDeleteViaRightClick()
        {
            ...
            AddUntilStep(
                ...
                () => leaderboard.Scores.All(s => s.OnlineID != scoreBeingDeleted.OnlineID)
            );
        ...
        public void TestDeleteViaDatabase()
        {
            ...
            AddUntilStep(
                "score removed from leaderboard",
                () => leaderboard.Scores.All(s => s.OnlineID != importedScores[0].OnlineID)
            );
        }
    }
}
