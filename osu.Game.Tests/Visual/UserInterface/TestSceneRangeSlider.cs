    ...
    public partial class TestSceneRangeSlider : OsuTestScene
    {
        ...
        public void TestAdjustRange()
        {
            AddAssert(
                ...
                () => rangeSlider.LowerBound.Value,
                () => Is.EqualTo(0).Within(0.1f)
            );
            AddAssert(
                "Initial upper bound is correct",
                () => rangeSlider.UpperBound.Value,
                () => Is.EqualTo(100).Within(0.1f)
            );
            ...
            AddAssert(
                ...
                () => rangeSlider.LowerBound.Value,
                () => Is.EqualTo(50).Within(0.1f)
            );
            AddAssert(
                "Adjusted upper bound is correct",
                () => rangeSlider.UpperBound.Value,
                () => Is.EqualTo(75).Within(0.1f)
            );
