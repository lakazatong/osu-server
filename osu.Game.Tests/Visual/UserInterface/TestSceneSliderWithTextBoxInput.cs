...
namespace osu.Game.Tests.Visual.UserInterface
{
    public partial class TestSceneSliderWithTextBoxInput : OsuManualInputManagerTestScene
    {
        ...
        private OsuSliderBar<float> slider =>
            sliderWithTextBoxInput.ChildrenOfType<OsuSliderBar<float>>().Single();
        ...
        public void SetUpSteps()
        {
            AddStep(
                "create slider",
                () =>
                    Child = sliderWithTextBoxInput =
                        new SliderWithTextBoxInput<float>("Test Slider")
                        {
        ...
        {
            AddStep(
                "set instantaneous to false",
                () => sliderWithTextBoxInput.Instantaneous = false
            );
            ...
            AddAssert(
                "current not changed",
                () => sliderWithTextBoxInput.Current.Value,
                () => Is.Zero
            );
            ...
            AddStep(
                "move mouse to minimum",
                () =>
                    InputManager.MoveMouseTo(sliderWithTextBoxInput.ScreenSpaceDrawQuad.BottomLeft)
            );
