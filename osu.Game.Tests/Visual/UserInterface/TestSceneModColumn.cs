...
namespace osu.Game.Tests.Visual.UserInterface
{
    ...
    public partial class TestSceneModColumn : OsuManualInputManagerTestScene
    {
        ...
        public void TestMultiSelection()
        {
            ...
            AddStep(
                ...
                () =>
                    Child = new Container
                    {
                        ...
                        Padding = new MarginPadding(30),
                        Child = column =
                            new ModColumn(ModType.DifficultyIncrease, true)
                            {
                                Anchor = Anchor.Centre,
                                Origin = Anchor.Centre,
            ...
            AddUntilStep(
                "all panels selected",
                () => this.ChildrenOfType<ModPanel>().All(panel => panel.Active.Value)
            );

            clickToggle();
            AddUntilStep(
                "all panels deselected",
                () => this.ChildrenOfType<ModPanel>().All(panel => !panel.Active.Value)
            );

            AddStep(
                "manually activate all panels",
                () => this.ChildrenOfType<ModPanel>().ForEach(panel => panel.Active.Value = true)
            );
            AddUntilStep(
                "checkbox selected",
                () => this.ChildrenOfType<OsuCheckbox>().Single().Current.Value
            );

            AddStep(
                "deselect first panel",
                () => this.ChildrenOfType<ModPanel>().First().Active.Value = false
            );
            AddUntilStep(
        ...
        public void TestFiltering()
        {
            ...
            AddStep(
                ...
                () =>
                    Child = new Container
                    {
                        ...
                        Padding = new MarginPadding(30),
                        Child = column =
                            new TestModColumn(ModType.Fun, true)
                            {
                                Anchor = Anchor.Centre,
                                Origin = Anchor.Centre,
            ...
            AddStep(
                ...
                () =>
                    setFilter(mod =>
                        mod.Name.Contains("Wind", StringComparison.CurrentCultureIgnoreCase)
                    )
            );
            AddUntilStep(
                "two panels visible",
                () => column.ChildrenOfType<ModPanel>().Count(panel => panel.Visible) == 2
            );

            clickToggle();
            AddUntilStep("wait for animation", () => !column.SelectionAnimationRunning);
            AddAssert(
                "only visible items selected",
                () =>
                    column
                        .ChildrenOfType<ModPanel>()
                        .Where(panel => panel.Active.Value)
            ...
            AddUntilStep(
                "all panels visible",
                () => column.ChildrenOfType<ModPanel>().All(panel => panel.Visible)
            );
            AddAssert(
                "checkbox not selected",
                () => !column.ChildrenOfType<OsuCheckbox>().Single().Current.Value
            );
            ...
            AddUntilStep(
                "checkbox hidden",
                () => !column.ChildrenOfType<OsuCheckbox>().Single().IsPresent
            );
        ...
        {
            AddStep(
                "set sequential hotkey mode",
                () =>
                    configManager.SetValue(
                        OsuSetting.ModSelectHotkeyStyle,
                        ModSelectHotkeyStyle.Sequential
                    )
            );
            ...
            AddStep(
                ...
                () =>
                    Child = new Container
                    {
                        ...
                        Padding = new MarginPadding(30),
                        Child = column =
                            new ModColumn(ModType.DifficultyReduction, true)
                            {
                                Anchor = Anchor.Centre,
                                Origin = Anchor.Centre,
            ...
            AddAssert(
                ...
                () =>
                    this.ChildrenOfType<ModPanel>()
                        .Single(panel => panel.Mod.Acronym == "NF")
                        .Active.Value
            );
        ...
        public void TestClassicKeyboardExclusiveSelection()
        {
            ...
            AddStep(
                ...
                () =>
                    Child = new Container
                    {
                        ...
                        Padding = new MarginPadding(30),
                        Child = column =
                            new ModColumn(ModType.DifficultyIncrease, false)
                            {
                                Anchor = Anchor.Centre,
                                Origin = Anchor.Centre,
                                AvailableMods = getExampleModsFor(ModType.DifficultyIncrease),
            ...
            AddAssert(
                ...
                () =>
                    this.ChildrenOfType<ModPanel>()
                        .Single(panel => panel.Mod.Acronym == "HR")
                        .Active.Value
            );
            ...
            AddAssert(
                ...
                () =>
                    this.ChildrenOfType<ModPanel>()
                        .Single(panel => panel.Mod.Acronym == "DT")
                        .Active.Value
            );
            ...
            AddAssert(
                ...
                () =>
                    this.ChildrenOfType<ModPanel>()
                        .Single(panel => panel.Mod.Acronym == "NC")
                        .Active.Value
            );
            ...
            AddAssert(
                "no change",
                () =>
                    this.ChildrenOfType<ModPanel>().Single(panel => panel.Active.Value).Mod.Acronym
                    == "NC"
            );
        ...
        public void TestClassicKeyboardIncompatibleSelection()
        {
            ...
            AddAssert(
                "no change",
                () => this.ChildrenOfType<ModPanel>().Count(panel => panel.Active.Value) == 2
            );
        ...
        {
            Mod hidden = getExampleModsFor(ModType.DifficultyIncrease)
                .Where(modState => modState.Mod is ModHidden)
            ...
            void applySearchAndAssert(string searchTerm)
            {
                ...
                AddAssert(
                    "only hidden is visible",
                    () =>
                        column
                            .ChildrenOfType<ModPanel>()
                            .Where(panel => panel.Visible)
                            .All(panel => panel.Mod is ModHidden)
                );
            }
