...
namespace osu.Game.Tests.Visual.UserInterface
{
    public partial class TestSceneModCustomisationPanel : OsuManualInputManagerTestScene
    {
        ...
        public void TestDisplay()
        {
            AddStep(
                ...
                () =>
                {
                    ...
                    panel.ExpandedState.Value = ModCustomisationPanel
        ...
        public void TestHoverExpandsAndCollapsesWhenHeaderTouched()
        {
            ...
            AddStep(
                "touch away from header",
                () =>
                {
                    var touch = new Touch(
                        TouchSource.Touch1,
                        header.ScreenSpaceDrawQuad.TopLeft - new Vector2(10)
                    );
                    InputManager.BeginTouch(touch);
                    Schedule(() => InputManager.EndTouch(touch));
                }
        ...
        {
            AddUntilStep(
                expanded ? "is expanded" : "not expanded",
                () => panel.ExpandedState.Value,
                () =>
                    expanded
