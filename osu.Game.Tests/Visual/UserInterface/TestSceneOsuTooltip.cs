...
namespace osu.Game.Tests.Visual.UserInterface
{
    ...
    public partial class TestSceneOsuTooltip : OsuManualInputManagerTestScene
    {
        ...
        public void TestTooltipBasic(string text)
        {
                ...
                () =>
                    InputManager.MoveMouseTo(
                        new Vector2(
                            ...
                            InputManager.ScreenSpaceDrawQuad.Centre.Y
                        )
                    )
            );
            ...
            AddUntilStep(
                "Wait for the tooltip shown",
                () =>
                {
                    tooltip = container
                        .FindClosestParent<OsuTooltipContainer>()
                        .ChildrenOfType<OsuTooltipContainer.OsuTooltip>()
                        .FirstOrDefault();
            ...
            AddAssert(
                "Check tooltip is under width limit",
                () => tooltip != null && tooltip.Width <= 500
            );
        }
