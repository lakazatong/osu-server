...
namespace osu.Game.Tests.Visual.UserInterface
{
    public partial class TestSceneShearedRangeSlider : ThemeComparisonTestScene
    {
        ...
        public void SetUpSteps()
        {
            ...
            AddAssert(
                "Initial lower bound is correct",
                () => shearedRangeSlider.LowerBound.Value,
                () => Is.EqualTo(0).Within(0.1f)
            );
            AddAssert(
                "Initial upper bound is correct",
                () => shearedRangeSlider.UpperBound.Value,
                () => Is.EqualTo(10).Within(0.1f)
            );
        }
        ...
        public void TestAdjustRange()
        {
            ...
            AddAssert(
                "Adjusted lower bound is correct",
                () => shearedRangeSlider.LowerBound.Value,
                () => Is.EqualTo(5).Within(0.1f)
            );
            AddAssert(
                "Adjusted upper bound is correct",
                () => shearedRangeSlider.UpperBound.Value,
                () => Is.EqualTo(7.5).Within(0.1f)
            );
            ...
            AddAssert(
                "Pushed lower bound is correct",
                () => shearedRangeSlider.LowerBound.Value,
                () => Is.EqualTo(9).Within(0.1f)
            );
            AddAssert(
                "Pushed upper bound is correct",
                () => shearedRangeSlider.UpperBound.Value,
                () => Is.EqualTo(9.1).Within(0.1f)
            );
        }
        ...
        public void TestAdjustRangeClickOutsideNub()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    InputManager.MoveMouseTo(
                        lowerBoundNub + new Vector2((upperBoundNub.X - lowerBoundNub.X) * 0.75f, 0)
                    );
            ...
            AddAssert(
                "Adjusted lower bound is correct",
                () => shearedRangeSlider.LowerBound.Value,
                () => Is.EqualTo(0).Within(0.11f)
            );
            AddAssert(
                "Adjusted upper bound is correct",
                () => shearedRangeSlider.UpperBound.Value,
                () => Is.EqualTo(7.5).Within(0.11f)
            );
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        lowerBoundNub + new Vector2((upperBoundNub.X - lowerBoundNub.X) * 0.3f, 0)
                    );
                    InputManager.Click(MouseButton.Left);
                }
            );
