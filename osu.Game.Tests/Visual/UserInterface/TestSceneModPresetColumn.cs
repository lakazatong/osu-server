...
namespace osu.Game.Tests.Visual.UserInterface
{
    public partial class TestSceneModPresetColumn : OsuManualInputManagerTestScene
    {
        ...
        public void TestBasicOperation()
        {
            ...
            AddStep(
                "create content",
                () => Child = new ModPresetColumn { Anchor = Anchor.Centre, Origin = Anchor.Centre }
            );
            AddUntilStep(
                "3 panels visible",
                () => this.ChildrenOfType<ModPresetPanel>().Count() == 3
            );

            AddStep("change ruleset to mania", () => Ruleset.Value = rulesets.GetRuleset(3));
            AddUntilStep(
                "1 panel visible",
                () => this.ChildrenOfType<ModPresetPanel>().Count() == 1
            );

            AddStep(
                "add another mania preset",
                () =>
                    Realm.Write(r =>
                        r.Add(
                            new ModPreset
            ...
            AddUntilStep(
                "2 panels visible",
                () => this.ChildrenOfType<ModPresetPanel>().Count() == 2
            );

            AddStep(
                "add another osu! preset",
                () =>
                    Realm.Write(r =>
                        r.Add(
                            new ModPreset
            ...
            AddStep(
                ...
                () =>
                    Realm.Write(r =>
                    {
                        var toRemove = r.All<ModPreset>()
                            .Single(preset => preset.Name == "Different ruleset");
                        r.Remove(toRemove);
                    })
            );
            AddUntilStep(
            ...
            AddUntilStep(
                "4 panels visible",
                () => this.ChildrenOfType<ModPresetPanel>().Count() == 4
            );
        }
        ...
        public void TestSoftDeleteSupport()
        {
            ...
            AddStep(
                ...
                () =>
                    Realm.Write(r =>
                    {
                        var toSoftDelete = r.All<ModPreset>()
                            .Single(preset => preset.Name == "AR0");
            ...
            AddStep(
                "select mods from first preset",
                () =>
                    SelectedMods.Value = new Mod[] { new OsuModDoubleTime(), new OsuModHardRock() }
            );
        ...
        public void TestAddingFlow([Values] bool withSystemModActive)
        {
            ...
            AddStep(
                "create content",
                () =>
                    Child = modPresetColumn =
                        new ModPresetColumn { Anchor = Anchor.Centre, Origin = Anchor.Centre }
            );

            AddUntilStep(
                "items loaded",
                () => modPresetColumn.IsLoaded && modPresetColumn.ItemsLoaded
            );
            AddAssert(
                "add preset button disabled",
                () => !this.ChildrenOfType<AddPresetButton>().Single().Enabled.Value
            );
            ...
            AddUntilStep(
                "wait for popover",
                () => (popover = this.ChildrenOfType<OsuPopover>().FirstOrDefault()) != null
            );
            AddStep(
                "attempt preset creation",
                () =>
                {
            ...
            AddAssert(
                "preset creation did not occur",
                () => this.ChildrenOfType<ModPresetPanel>().Count() == 3
            );
            AddUntilStep(
                "popover is unchanged",
                () => this.ChildrenOfType<OsuPopover>().FirstOrDefault() == popover
            );

            AddStep(
                "fill preset name",
                () => popover.ChildrenOfType<LabelledTextBox>().First().Current.Value = "new preset"
            );
            AddStep(
                "attempt preset creation",
                () =>
            ...
            AddUntilStep(
                "preset creation occurred",
                () => this.ChildrenOfType<ModPresetPanel>().Count() == 4
            );
            AddAssert(
                "preset has correct mods",
                () =>
                    this.ChildrenOfType<ModPresetPanel>()
                        .Single(panel => panel.Preset.Value.Name == "new preset")
                        .Preset.Value.Mods,
                () => Has.Count.EqualTo(2)
            );
        ...
        public void TestDeleteFlow()
        {
            ...
            AddUntilStep(
                ...
                () => this.ChildrenOfType<OsuContextMenu>().Any()
            );
            AddStep(
                "click delete",
                () =>
            ...
            AddUntilStep(
                "wait for dialog",
                () => dialogOverlay.CurrentDialog is DeleteModPresetDialog
            );
            AddStep(
                "hold confirm",
                () =>
            ...
            AddUntilStep(
                "preset deletion occurred",
                () => this.ChildrenOfType<ModPresetPanel>().Count() == 2
            );
            AddAssert(
                "preset soft-deleted",
                () => Realm.Run(r => r.All<ModPreset>().Count(preset => preset.DeletePending) == 1)
            );
        }
        ...
        public void TestEditPresetName()
        {
            ...
            AddStep(
                "clear preset name",
                () => popover.ChildrenOfType<LabelledTextBox>().First().Current.Value = ""
            );
            AddStep(
                "attempt preset edit",
                () =>
        ...
        public void TestEditPresetMod()
        {
            ...
            AddUntilStep(
                "preset mod not changed",
                () =>
                    new HashSet<Mod>(
                        this.ChildrenOfType<ModPresetPanel>().First().Preset.Value.Mods
                    ).SetEquals(previousMod)
            );
        ...
        public void TestTextFiltering()
        {
            ...
            AddUntilStep(
                ...
                () =>
                    modPresetColumn
                        .ChildrenOfType<ModPresetPanel>()
                        .Count(panel => panel.IsPresent),
                () => Is.EqualTo(1)
            );
        ...
        private ICollection<ModPreset> createTestPresets() =>
            new[]
            {
                new ModPreset
                {
                ...
                new ModPreset
                {
                    ...
                    Mods = new Mod[] { new ManiaModKey4(), new ManiaModFadeIn() },
