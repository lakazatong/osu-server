    ...
    public partial class TestSceneBlueprintOrdering : EditorTestScene
    {
        ...
        public void TestSelectedObjectHasPriorityWhenOverlapping()
        {
            ...
            AddAssert(
                ...
                () => EditorBeatmap.SelectedHitObjects.Single() == firstSlider
            );
        }
        ...
        public void TestOverlappingObjectsWithSameStartTime()
        {
            AddStep(
                ...
                () =>
                {
                    ...
                    EditorBeatmap.Add(
                        createHitCircle(50, OsuPlayfield.BASE_SIZE / 2 + new Vector2(-10, -20))
                    );
                    EditorBeatmap.Add(
                        createHitCircle(50, OsuPlayfield.BASE_SIZE / 2 + new Vector2(10, -20))
                    );
            ...
            AddAssert(
                "frontmost object selected",
                () =>
                {
                    var hasCombo =
                        Editor
                            .ChildrenOfType<HitCircleSelectionBlueprint>()
                            .Single(b => b.IsSelected)
                            .Item as IHasComboInformation;
        ...
        public void TestPlacementOfConcurrentObjectWithDuration()
        {
            ...
            AddAssert(
                "two timeline blueprints present",
                () => Editor.ChildrenOfType<TimelineHitObjectBlueprint>().Count() == 2
            );
        }

        private HitCircle createHitCircle(double startTime, Vector2 position) =>
            new HitCircle { StartTime = startTime, Position = position };
    }
}
