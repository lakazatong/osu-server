    ...
    public partial class TestSceneEditorTestGameplay : EditorTestScene
    {
        ...
        protected override WorkingBeatmap CreateWorkingBeatmap(
            ...
            beatmaps.GetWorkingBeatmap(
                importedBeatmapSet.Beatmaps.First(b => b.Ruleset.OnlineID == 0)
            );
        ...
        public void TestBasicGameplayTest()
        {
            ...
            AddUntilStep(
                "player pushed",
                () => (editorPlayer = Stack.CurrentScreen as EditorPlayer) != null
            );
            ...
            AddUntilStep(
                ...
                () =>
                    this.ChildrenOfType<BackgroundScreenStack>().Single().CurrentScreen
                    is EditorBackgroundScreen
            );
        ...
        public void TestGameplayTestResetsPlaybackSpeedAdjustment()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        this.ChildrenOfType<PlaybackControl.PlaybackTabControl.PlaybackTabItem>()
                            .First()
                    );
                    InputManager.Click(MouseButton.Left);
                }
            ...
            AddAssert(
                "track playback rate is 0.25x",
                () => Beatmap.Value.Track.AggregateTempo.Value,
                () => Is.EqualTo(0.25)
            );
        ...
        {
            AddStep(
                $"seek to end minus {offsetFromEnd}ms",
                () => EditorClock.Seek(importedBeatmapSet.MaxLength - offsetFromEnd)
            );
            AddStep(
                "click test gameplay button",
                () =>
        ...
        {
            AddStep(
                "delete all but first object",
                () => EditorBeatmap.RemoveRange(EditorBeatmap.HitObjects.Skip(1).ToList())
            );
        ...
        public void TestSaveChangesBeforeGameplayTest()
        {
            ...
            AddStep(
                ...
                () => EditorBeatmap.BeatmapInfo.DifficultyName = Guid.NewGuid().ToString()
            );
            ...
            AddAssert(
                "beatmap has 1 object",
                () => editorPlayer.Beatmap.Value.Beatmap.HitObjects.Count == 1
            );
        ...
        public void TestClockTimeTransferIsOneDirectional()
        {
            ...
            AddStep(
                "fetch gameplay clock",
                () =>
                    gameplayClockContainer = editorPlayer
            ...
            AddAssert(
                "gameplay time past 00:01:00",
                () => gameplayClockContainer.CurrentTime >= 60_000
            );
        ...
        public void TestAutoplayToggle()
        {
            ...
            AddUntilStep(
                "no replay active",
                () => editorPlayer.ChildrenOfType<DrawableRuleset>().Single().ReplayScore,
                () => Is.Null
            );
        ...
        public void TestQuickPause()
        {
            ...
            AddUntilStep(
                "clock running",
                () => editorPlayer.ChildrenOfType<GameplayClockContainer>().Single().IsPaused.Value,
                () => Is.False
            );
            AddStep(
                "press Ctrl-P",
