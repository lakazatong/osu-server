    ...
    public partial class TestScenePlaylistsRoomSubScreen : OnlinePlayTestScene
    {
        ...
        public void TestBeatmapAndRuleset_FollowSelection()
        {
            ...
            AddStep(
                ...
                () =>
                    LoadScreen(
                        new TestPlaylistsScreen(screen = new TestPlaylistsRoomSubScreen(room))
                    )
            );
            ...
            AddUntilStep(
                "first beatmap selected",
                () => Beatmap.Value.BeatmapInfo.Equals(importedSet.Beatmaps[0])
            );
            AddUntilStep(
                "osu ruleset selected",
                () => Ruleset.Value.Equals(new OsuRuleset().RulesetInfo)
            );

            AddStep("select second item", () => screen.SelectedItem.Value = room.Playlist[1]);
            AddUntilStep(
                "second beatmap selected",
                () => Beatmap.Value.BeatmapInfo.Equals(importedSet.Beatmaps[1])
            );
            AddUntilStep(
                "taiko ruleset selected",
                () => Ruleset.Value.Equals(new TaikoRuleset().RulesetInfo)
            );
        }
        ...
        public void TestRulesetStyle_Reset_OnSelection_IfNotValid()
        {
            ...
            AddStep(
                "set user ruleset style",
                () => screen.UserRuleset.Value = new ManiaRuleset().RulesetInfo
            );
            AddUntilStep(
                "user ruleset selected",
                () => Ruleset.Value.Equals(new ManiaRuleset().RulesetInfo)
            );

            AddStep("select second item", () => screen.SelectedItem.Value = room.Playlist[1]);
            AddUntilStep("user ruleset style reset", () => screen.UserRuleset.Value == null);
            AddUntilStep(
                "second ruleset selected",
                () => Ruleset.Value.Equals(new TaikoRuleset().RulesetInfo)
            );
        }
        ...
        public void TestRulesetStyle_Preserved_OnSelection_IfStillValid()
        {
            ...
            AddStep("select second item", () => screen.SelectedItem.Value = room.Playlist[1]);
            AddUntilStep(
                "user ruleset style preserved",
                () => screen.UserRuleset.Value!.Equals(new ManiaRuleset().RulesetInfo)
            );
            AddUntilStep(
                "user ruleset selected",
                () => Ruleset.Value.Equals(new ManiaRuleset().RulesetInfo)
        ...
        public void TestModsReset_OnSelection_DifferentRuleset_NoUserStyle()
        {
            ...
            AddUntilStep(
                "user mods selected",
                () => SelectedMods.Value.OfType<OsuModDoubleTime>().Any()
            );
        ...
        public void TestModsPreserved_OnSelection_SameRuleset_NoUserStyle()
        {
            ...
            AddStep("select second item", () => screen.SelectedItem.Value = room.Playlist[1]);
            AddUntilStep(
                "user mod style preserved",
                () => screen.UserMods.Value.OfType<OsuModDoubleTime>().Any()
            );
            AddUntilStep(
                "mods preserved",
                () => SelectedMods.Value.OfType<OsuModDoubleTime>().Any()
        ...
        public void TestModsReset_OnSelection_DifferentRuleset_WithUserStyle()
        {
            ...
            AddStep(
                "set user ruleset",
                () => screen.UserRuleset.Value = new CatchRuleset().RulesetInfo
            );
            AddUntilStep(
                "user ruleset selected",
                () => Ruleset.Value.Equals(new CatchRuleset().RulesetInfo)
            );
            AddStep("set user mods", () => screen.UserMods.Value = [new CatchModDoubleTime()]);
            AddUntilStep(
                "user mods selected",
                () => SelectedMods.Value.OfType<CatchModDoubleTime>().Any()
            );
        ...
        public void TestModsPreserved_OnSelection_SameRuleset_WithStyle()
        {
            ...
            AddUntilStep(
                "user mods selected",
                () => SelectedMods.Value.OfType<TaikoModDoubleTime>().Any()
            );

            AddStep("select second item", () => screen.SelectedItem.Value = room.Playlist[1]);
            AddUntilStep(
                "user mod style preserved",
                () => screen.UserMods.Value.OfType<TaikoModDoubleTime>().Any()
            );
            AddUntilStep(
                "mods preserved",
                () => SelectedMods.Value.OfType<TaikoModDoubleTime>().Any()
        ...
        public void TestUserStyle_Reset_OnFreestyleDisabled()
        {
            ...
            AddStep(
                "set user beatmap/ruleset style",
                () =>
                {
                    screen.UserBeatmap.Value = importedSet.Beatmaps[1];
                    screen.UserRuleset.Value = new TaikoRuleset().RulesetInfo;
            ...
            AddStep(
                "select second playlist item",
                () => screen.SelectedItem.Value = room.Playlist[1]
            );
            AddUntilStep(
                "user style reset",
                () => screen.UserBeatmap.Value == null && screen.UserRuleset.Value == null
            );
            AddUntilStep(
                "beatmap/ruleset set",
                () =>
            ...
            AddStep(
                "set user mods style",
                () => screen.UserMods.Value = [new OsuModDoubleTime(), new OsuModHardRock()]
            );
            AddUntilStep(
                "mods set",
                () =>
                    SelectedMods.Value.OfType<OsuModDoubleTime>().Any()
                    && SelectedMods.Value.OfType<OsuModHardRock>().Any()
            );
            AddStep(
                "select second playlist item",
                () => screen.SelectedItem.Value = room.Playlist[1]
            ...
            AddUntilStep(
                "user mods validated",
                () =>
                    screen.UserMods.Value.Count == 1
                    && screen.UserMods.Value.OfType<OsuModDoubleTime>().Any()
            );
            AddUntilStep(
                "mods set",
                () =>
                    SelectedMods.Value.Count == 1
                    && SelectedMods.Value.OfType<OsuModDoubleTime>().Any()
            );
        }
        ...
        private partial class TestPlaylistsScreen : OsuScreen
        {
            public TestPlaylistsScreen(PlaylistsRoomSubScreen screen)
            {
                ...
                {
                    stack = new OnlinePlaySubScreenStack { RelativeSizeAxes = Axes.Both },
                    new BackButton
                    {
