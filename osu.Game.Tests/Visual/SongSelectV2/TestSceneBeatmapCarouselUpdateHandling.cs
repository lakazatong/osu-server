...
namespace osu.Game.Tests.Visual.SongSelectV2
{
    ...
    public partial class TestSceneBeatmapCarouselUpdateHandling : BeatmapCarouselTestScene
    {
        ...
        public void TestBeatmapSetUpdatedNoop()
        {
            ...
            AddStep(
                "update beatmap with same reference",
                () => BeatmapSets.ReplaceRange(1, 1, [baseTestBeatmap])
            );
        ...
        public void TestBeatmapSetMetadataUpdated()
        {
            ...
            AddStep(
                ...
                () =>
                    panel = Carousel
                        .ChildrenOfType<PanelBeatmapSet>()
                        .Single(p =>
                            p.ChildrenOfType<OsuSpriteText>()
                                .Any(t => t.Text.ToString() == "beatmap")
                        )
            );
            ...
            AddAssert(
                ...
                () =>
                    panel
                        ...
                        .Any(t => t.Text.ToString() == metadata.Title)
            );
        }
        ...
        public void TestSelectionHeld()
        {
            ...
            AddAssert(
                "selection is updateable beatmap",
                () => Carousel.CurrentSelection,
                () => Is.EqualTo(baseTestBeatmap.Beatmaps[0])
            );
            AddAssert(
                "visible panel is updateable beatmap",
        ...
        public void TestSortingStabilityWithRemovedAndReaddedItem()
        {
            ...
            AddAssert(
                ...
                () => Carousel.PostFilterBeatmaps.Select(b => b.BeatmapSet!.DateAdded),
                () => Is.Ordered.Descending
            );
            AddStep(
                "Save order",
                () => originalOrder = Carousel.PostFilterBeatmaps.Select(b => b.ID).ToArray()
            );
            ...
            AddAssert(
                "Order didn't change",
                () => Carousel.PostFilterBeatmaps.Select(b => b.ID),
        ...
        private void updateBeatmap(
            Action<BeatmapInfo>? updateBeatmap = null,
            Action<BeatmapSetInfo>? updateSet = null
        )
        {
            AddStep(
                "update beatmap with different reference",
                () =>
                {
                    ...
                    var updatedBeatmaps = baseTestBeatmap
                        .Beatmaps.Select(b =>
                        {
