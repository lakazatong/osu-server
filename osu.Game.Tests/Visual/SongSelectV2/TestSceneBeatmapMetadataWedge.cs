...
namespace osu.Game.Tests.Visual.SongSelectV2
{
    public partial class TestSceneBeatmapMetadataWedge : SongSelectComponentsTestScene
    {
        ...
        protected override void LoadComplete()
        {
            ...
            Child = wedge = new BeatmapMetadataWedge { State = { Value = Visibility.Visible } };
        }
        ...
        public void TestTruncation()
        {
            AddStep(
                ...
                () =>
                {
                    ...
                    working.BeatmapInfo.Metadata.Author = new RealmUser
                    {
                        Username = "Verrrrryyyy llooonngggggg author",
                    };
                    working.BeatmapInfo.Metadata.Source = "Verrrrryyyy llooonngggggg source";
                    working.BeatmapInfo.Metadata.Tags = string.Join(
                        ' ',
                        Enumerable.Repeat(working.BeatmapInfo.Metadata.Tags, 3)
                    );
                    onlineSet.Genre = new BeatmapSetOnlineGenre
                    {
                        Id = 12,
                        Name = "Verrrrryyyy llooonngggggg genre",
                    };
                    onlineSet.Language = new BeatmapSetOnlineLanguage
                    {
                        Id = 12,
                        Name = "Verrrrryyyy llooonngggggg language",
                    };
                    onlineSet.Beatmaps.Single().TopTags = Enumerable
                        .Repeat(onlineSet.Beatmaps.Single().TopTags, 3)
                        .SelectMany(t => t!)
                        .ToArray();
