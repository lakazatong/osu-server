...
namespace osu.Game.Tests.Visual.SongSelectV2
{
    public partial class TestSceneSongSelect : SongSelectTestScene
    {
        ...
        public void TestResultsScreenWhenClickingLeaderboardScore()
        {
            ...
            AddAssert(
                "beatmap imported",
                () => Beatmaps.GetAllUsableBeatmapSets().Any(),
                () => Is.True
            );
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        SongSelect
                            .ChildrenOfType<BeatmapDetailsArea.WedgeSelector<BeatmapDetailsArea.Header.Selection>>()
                            .Last()
                    );
            ...
            AddUntilStep(
                "wait for score panel",
                () => SongSelect.ChildrenOfType<BeatmapLeaderboardScore>().Any()
            );
            AddStep(
                "click score panel",
                () =>
                {
                    InputManager.MoveMouseTo(
                        SongSelect.ChildrenOfType<BeatmapLeaderboardScore>().Single()
                    );
                    InputManager.Click(MouseButton.Left);
                }
            );
        ...
        public void TestCookieDoesNothingIfNothingSelected()
        {
            ...
            void onScreenPushed(IScreen lastScreen, IScreen newScreen) =>
                screensPushed.Add(lastScreen);
        }
        ...
        public void TestInvalidRulesetDoesNotEnterGameplay()
        {
            ...
            AddStep(
                "change ruleset to taiko",
                () => Ruleset.Value = Rulesets.AvailableRulesets.Single(r => r.OnlineID == 1)
            );
            ...
            AddUntilStep(
                "wait for taiko beatmap selected",
                () => Beatmap.Value.BeatmapInfo.Ruleset.OnlineID,
                () => Is.EqualTo(1)
            );

            AddStep(
                "change ruleset back and start gameplay immediately",
                () =>
                {
        ...
        public void TestSpeedChange()
        {
            ...
            AddAssert(
                ...
                () => SelectedMods.Value.OfType<ModHalfTime>().Single().SpeedChange.Value,
            ...
            AddAssert(
                ...
                () => SelectedMods.Value.OfType<ModDoubleTime>().Single().SpeedChange.Value,
            ...
            AddAssert(
                ...
                () => SelectedMods.Value.OfType<ModNightcore>().Single().SpeedChange.Value,
                () => Is.EqualTo(1.1).Within(0.005)
            );
            ...
            AddAssert(
                ...
                () => SelectedMods.Value.OfType<ModDaycore>().Single().SpeedChange.Value,
                () => Is.EqualTo(0.95).Within(0.005)
            );
            ...
            AddAssert(
                ...
                () => SelectedMods.Value.OfType<ModHalfTime>().Single().AdjustPitch.Value,
                () => Is.True
            );
            ...
            AddAssert(
                "double time activated at 1.02x",
                () => SelectedMods.Value.OfType<ModDoubleTime>().Single().AdjustPitch.Value,
                () => Is.True
            );
            AddAssert(
                "HD still enabled",
                () => SelectedMods.Value.OfType<ModHidden>().SingleOrDefault(),
                () => Is.Not.Null
            );
            AddAssert(
                "HR still enabled",
                () => SelectedMods.Value.OfType<ModHardRock>().SingleOrDefault(),
                () => Is.Not.Null
            );
            ...
            AddAssert(
                ...
                () => SelectedMods.Value.First() is ModAdaptiveSpeed
            );
            ...
            AddStep(
                ...
                () => SelectedMods.Value.OfType<ModHalfTime>().Single().AdjustPitch.Value = false
            );
        ...
        public void TestModSelectCannotBeOpenedAfterConfirmingSelection()
        {
            ...
            AddAssert(
                ...
                () => this.ChildrenOfType<ModSelectOverlay>().Single().State.Value,
            ...
            AddAssert(
                "osu! cookie visible",
                () => this.ChildrenOfType<OsuLogo>().Single().Alpha,
                () => Is.Not.Zero
            );
        }
        ...
        public void TestFooterMods()
        {
            ...
            AddStep(
                "two mods",
                () =>
                    SelectedMods.Value = new List<Mod> { new OsuModHidden(), new OsuModHardRock() }
            );
            AddStep(
                "three mods",
                () =>
        ...
        private FooterButtonRandom randomButton =>
            Footer.ChildrenOfType<FooterButtonRandom>().Single();
        ...
        public void TestFooterOptions()
        {
            ...
            AddAssert(
                "options enabled",
                () => this.ChildrenOfType<FooterButtonOptions>().Single().Enabled.Value
            );

            AddStep(
                "click",
                () => this.ChildrenOfType<FooterButtonOptions>().Single().TriggerClick()
            );
            AddUntilStep(
                "popover displayed",
                () => this.ChildrenOfType<FooterButtonOptions.Popover>().Any(p => p.IsPresent)
            );
        }
        ...
        public void TestSelectionChangedFromProtectedToNone()
        {
            ImportBeatmapForRuleset(0);
            AddStep(
                "set protected on import",
                () =>
                    Realm.Write(r =>
                        r.All<BeatmapSetInfo>().First(s => !s.DeletePending).Protected = true
                    )
            );
            ...
            AddStep(
                ...
                () =>
                    Beatmap.Value = Beatmaps.GetWorkingBeatmap(
                        Beatmaps.GetAllUsableBeatmapSets().First(s => s.Protected).Beatmaps.First()
                    )
            );
