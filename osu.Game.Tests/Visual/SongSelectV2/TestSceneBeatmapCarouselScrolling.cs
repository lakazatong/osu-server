...
namespace osu.Game.Tests.Visual.SongSelectV2
{
    ...
    public partial class TestSceneBeatmapCarouselScrolling : BeatmapCarouselTestScene
    {
        ...
        public void TestScrollPositionMaintainedOnRemove_SecondSelected()
        {
            ...
            AddStep(
                "select middle beatmap",
                () =>
                    Carousel.CurrentSelection = BeatmapSets
                        .ElementAt(BeatmapSets.Count - 2)
                        .Beatmaps.First()
            );
            ...
            AddStep(
                "save selected screen position",
                () =>
                    positionBefore = Carousel
                        .ChildrenOfType<PanelBeatmap>()
                        .FirstOrDefault(p => p.Selected.Value)!
                        .ScreenSpaceDrawQuad
            );
            ...
            AddAssert(
                "select screen position unchanged",
                () =>
                    Carousel
                        .ChildrenOfType<PanelBeatmap>()
                        .Single(p => p.Selected.Value)
                        .ScreenSpaceDrawQuad,
        ...
        public void TestScrollPositionMaintainedOnRemove_SecondSelected_WithUserScroll()
        {
            ...
            AddStep(
                "override scroll with user scroll",
                () =>
                {
        ...
        public void TestScrollPositionMaintainedOnRemove_LastSelected()
        {
            ...
            AddStep(
                "select last beatmap",
                () => Carousel.CurrentSelection = BeatmapSets.Last().Beatmaps.Last()
            );
        ...
        public void TestScrollToSelectionAfterFilter()
        {
            ...
            AddStep(
                "select first beatmap",
                () => Carousel.CurrentSelection = BeatmapSets.First().Beatmaps.First()
            );
            ...
            AddUntilStep(
                "select screen position returned to selection",
                () =>
                    Carousel
                        .ChildrenOfType<PanelBeatmap>()
                        .Single(p => p.Selected.Value)
