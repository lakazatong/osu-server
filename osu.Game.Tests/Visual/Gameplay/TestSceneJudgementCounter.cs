...
namespace osu.Game.Tests.Visual.Gameplay
{
    public partial class TestSceneJudgementCounter : OsuTestScene
    {
                    ...
                    base.Content.Child = new DependencyProvidingContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            ...
                            content = new DependencyProvidingContainer
                            {
                                ...
                                CachedDependencies = new (Type, object)[]
                                {
                                    (typeof(JudgementCountController), judgementCountController),
                                },
                            },
                        },
                    };
        ...
        public void TestAddWhilstHidden()
        {
            ...
            AddStep(
                "Show all judgements",
                () => counterDisplay.Mode.Value = JudgementCounterDisplay.DisplayMode.All
            );
        }
        ...
        public void TestChangeFlowDirection()
        {
            ...
            AddStep(
                ...
                () => counterDisplay.FlowDirection.Value = Direction.Vertical
            );
            AddStep(
                "Set direction horizontal",
                () => counterDisplay.FlowDirection.Value = Direction.Horizontal
            );
        }
        ...
        public void TestToggleJudgementNames()
        {
            ...
            AddAssert(
                "Assert hidden",
                () => counterDisplay.CounterFlow.Children.First().ResultName.Alpha == 0
            );
            AddStep("Hide judgement names", () => counterDisplay.ShowJudgementNames.Value = true);
            AddWaitStep("wait some", 2);
            AddAssert(
                "Assert shown",
                () => counterDisplay.CounterFlow.Children.First().ResultName.Alpha == 1
            );
        }
        ...
        public void TestHideMaxValue()
        {
            ...
            AddAssert(
                "Check max hidden",
                () =>
                    counterDisplay.CounterFlow.ChildrenOfType<JudgementCounter>().First().Alpha == 0
            );
            ...
            AddStep(
                ...
                () =>
                    Child = counterDisplay =
                        new TestJudgementCounterDisplay { ShowMaxJudgement = { Value = false } }
            );
            AddAssert(
                "Check max hidden",
                () =>
        ...
        public void TestMaxValueHiddenOnModeChange()
        {
            ...
            AddStep(
                "Set max judgement to hide itself",
                () => counterDisplay.ShowMaxJudgement.Value = false
            );
            AddStep(
                "Show all judgements",
                () => counterDisplay.Mode.Value = JudgementCounterDisplay.DisplayMode.All
        ...
        public void TestNoDuplicates()
        {
            ...
            AddAssert(
                ...
                () =>
                    Is.EqualTo(
                        counterDisplay
                            .CounterFlow.ChildrenOfType<JudgementCounter>()
                            .Select(c => c.ResultName.Text)
                            .Distinct()
                            .Count()
                    )
            );
        ...
        public void TestCycleDisplayModes()
        {
            ...
            AddStep(
                "Show basic judgements",
                () => counterDisplay.Mode.Value = JudgementCounterDisplay.DisplayMode.Simple
            );
            AddWaitStep("wait some", 2);
            AddAssert(
                "Check only basic",
                () =>
                    counterDisplay.CounterFlow.ChildrenOfType<JudgementCounter>().Last().Alpha == 0
            );
            AddStep(
                "Show normal judgements",
                () => counterDisplay.Mode.Value = JudgementCounterDisplay.DisplayMode.Normal
            );
            AddStep(
                "Show all judgements",
                () => counterDisplay.Mode.Value = JudgementCounterDisplay.DisplayMode.All
            ...
            AddAssert(
                "Check all visible",
                () =>
                    counterDisplay.CounterFlow.ChildrenOfType<JudgementCounter>().Last().Alpha == 1
            );
        }

        private int hiddenCount()
        {
            var num = counterDisplay.CounterFlow.Children.First(child =>
                child.Result.Types.Contains(HitResult.LargeTickHit)
            );
