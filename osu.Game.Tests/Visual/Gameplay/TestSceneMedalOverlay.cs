...
namespace osu.Game.Tests.Visual.Gameplay
{
    ...
    {
        private readonly Bindable<OverlayActivation> overlayActivationMode =
        ...
        public void SetUpSteps()
        {
            ...
            overlayManagerMock
                .Setup(mock => mock.OverlayActivationMode)
                .Returns(overlayActivationMode);
            ...
            AddStep(
                ...
                () =>
                    Child = new DependencyProvidingContainer
                    {
                        ...
                        CachedDependencies = [(typeof(IOverlayManager), overlayManagerMock.Object)],
                    }
            );
        }
        ...
        private void awardMedal(UserAchievementUnlock unlock) =>
            AddStep(
                "award medal",
                () =>
                    dummyAPI.NotificationsClient.Receive(
                        new SocketMessage
                        {
                            Event = @"new",
