    ...
    public partial class TestSceneGameplaySamplePlayback : PlayerTestScene
    {
        ...
        public void TestAllSamplesStopDuringSeek()
        {
            ...
            AddUntilStep(
                ...
                () =>
                {
                    ...
                    slider = Player
                        .ChildrenOfType<DrawableSlider>()
                        .MinBy(s => s.HitObject.StartTime);
            ...
            AddUntilStep(
                "wait for slider sliding then seek",
                () =>
                {
            ...
            AddUntilStep(
                ...
                () => sampleDisabler.SamplePlaybackDisabled.Value
            );
            ...
            AddAssert(
                "all looping samples stopped immediately",
                () => allStopped(allLoopingSounds)
            );
            ...
            AddUntilStep(
                "seek finished, sample playback enabled",
                () => !sampleDisabler.SamplePlaybackDisabled.Value
            );
            AddUntilStep(
                "any sample is playing",
        ...
        protected override void Update()
        {
            ...
            if (seek)
            {
                ...
                var gameplayClockContainer = Player
        ...
        private IEnumerable<PausableSkinnableSound> allSounds =>
            Player.ChildrenOfType<PausableSkinnableSound>();
        private IEnumerable<PausableSkinnableSound> allLoopingSounds =>
            allSounds.Where(sound => sound.Looping);

        private bool allStopped(IEnumerable<PausableSkinnableSound> sounds) =>
            sounds.All(sound => !sound.IsPlaying);
