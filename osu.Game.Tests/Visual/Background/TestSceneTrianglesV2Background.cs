    ...
    public partial class TestSceneTrianglesV2Background : OsuTestScene
    {
        ...
        protected override void LoadComplete()
        {
            ...
            AddSliderStep(
                ...
                1f,
                0.02f,
                t => triangles.Thickness = maskedTriangles.Thickness = t
            );

            AddStep(
                "White colour",
                () => box.Colour = triangles.Colour = maskedTriangles.Colour = Color4.White
            );
            AddStep(
                "Vertical gradient",
                () =>
                    box.Colour =
                        triangles.Colour =
                        maskedTriangles.Colour =
                            ColourInfo.GradientVertical(Color4.White, Color4.Red)
            );
            AddStep(
                "Horizontal gradient",
                () =>
                    box.Colour =
                        triangles.Colour =
                        maskedTriangles.Colour =
                            ColourInfo.GradientHorizontal(Color4.White, Color4.Red)
            );
