    ...
    public partial class TestSceneDrawableRoomParticipantsList : OnlinePlayTestScene
    {
        ...
        public override void SetUpSteps()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    {
                        Name = "test room",
                        Host = new APIUser { Id = 2, Username = "peppy" },
                    };
        ...
        public void TestCircleCountNearLimit()
        {
            ...
            AddAssert(
                "0 hidden users",
                () =>
                    list.ChildrenOfType<DrawableRoomParticipantsList.HiddenUserCount>()
                        .Single()
                        .Count == 0
            );
        ...
        public void TestHiddenUsersBecomeDisplayed()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                AddAssert(
                    $"{displayedUsers} avatars displayed",
                    () => list.ChildrenOfType<UpdateableAvatar>().Count() == displayedUsers
                );
            }
        }
        ...
        public void TestCircleCount()
        {
            ...
            AddAssert(
                "3 users displayed",
                () => list.ChildrenOfType<UpdateableAvatar>().Count() == 3
            );
            AddAssert(
                "48 hidden users",
                () =>
            ...
            AddAssert(
                "10 users displayed",
                () => list.ChildrenOfType<UpdateableAvatar>().Count() == 10
            );
            AddAssert(
                "41 hidden users",
                () =>
        ...
        public void TestAddAndRemoveUsers()
        {
            ...
            AddAssert(
                "4 circles displayed",
                () => list.ChildrenOfType<UpdateableAvatar>().Count() == 4
            );
            AddAssert(
                "46 hidden users",
                () =>
            ...
            AddAssert(
                "1 circle displayed",
                () => list.ChildrenOfType<UpdateableAvatar>().Count() == 1
            );
        }

        private void addUser(int id)
        {
            room.RecentParticipants = room
                .RecentParticipants.Append(new APIUser { Id = id, Username = $"User {id}" })
                .ToArray();
        ...
        {
            room.RecentParticipants = room
                .RecentParticipants.Where(u => !u.Equals(room.RecentParticipants[index]))
                .ToArray();
            room.ParticipantCount--;
        }
    }
