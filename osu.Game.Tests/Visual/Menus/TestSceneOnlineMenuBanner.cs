...
namespace osu.Game.Tests.Visual.Menus
{
    public partial class TestSceneOnlineMenuBanner : OsuTestScene
    {
        ...
        public void TestBasic()
        {
                    ...
                    onlineMenuBanner.Current.Value = new APIMenuContent
                    {
                        Images = new[]
                        {
                            new APIMenuImage
                            {
                                ...
                                Url =
                                    @"https://osu.ppy.sh/home/news/2023-12-21-project-loved-december-2023",
                            },
                        },
                    }
            );
            ...
            AddUntilStep(
                ...
                () =>
                {
                    ...
                    return image.IsPresent
                        && image.Image.Url == "https://osu.ppy.sh/community/contests/189";
                }
            );

            AddStep(
                "set title with nonexistent image",
                () =>
                    onlineMenuBanner.Current.Value = new APIMenuContent
                    {
                        Images = new[]
            ...
            AddUntilStep(
                "wait for no image shown",
                () => !onlineMenuBanner.ChildrenOfType<OnlineMenuBanner.MenuImage>().Any()
            );
        }
        ...
        {
            AddStep(
                "set image with time constraints",
                () =>
                    onlineMenuBanner.Current.Value = new APIMenuContent
                    {
                        Images = new[]
        ...
        {
            AddStep(
                "set multiple images, second expiring soon",
                () =>
                    onlineMenuBanner.Current.Value = new APIMenuContent
                    {
                        Images = new[]
