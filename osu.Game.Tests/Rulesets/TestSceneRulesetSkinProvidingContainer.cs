...
namespace osu.Game.Tests.Rulesets
{
    ...
    public partial class TestSceneRulesetSkinProvidingContainer : OsuTestScene
    {
        ...
        protected override Ruleset CreateRuleset() =>
            new TestSceneRulesetDependencies.TestRuleset();
        ...
        public void TestRulesetResources()
        {
            ...
            AddAssert(
                "ruleset texture retrieved via skin",
                () => requester.GetTexture("test-image") != null
            );
            AddAssert(
                "ruleset sample retrieved via skin",
                () => requester.GetSample(new SampleInfo("test-sample")) != null
            );
        }
        ...
        public void TestEarlyAddedSkinRequester()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    requester.OnLoadAsync += () =>
                        textureOnLoad = requester.GetTexture("test-image");
        ...
        private partial class SkinRequester : Drawable, ISkin
        {
            ...
            public Texture GetTexture(
                ...
                WrapMode wrapModeS = default,
                WrapMode wrapModeT = default
            ) => skin.GetTexture(componentName);
