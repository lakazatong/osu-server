...
namespace osu.Game.Tests.Skins
{
    ...
    public partial class TestSceneSkinConfigurationLookup : OsuTestScene
    {
        ...
        public void TestBasicLookup()
        {
            ...
            AddAssert(
                "Check lookup finds beatmap skin",
                () => requester.GetConfig<string, string>("Lookup")?.Value == "beatmap skin"
            );
        }
        ...
        public void TestFloatLookup()
        {
            AddStep(
                "Add config values",
                () => userSource.Configuration.ConfigDictionary["FloatTest"] = "1.1"
            );
            AddAssert(
                "Check float parse lookup",
                () => requester.GetConfig<string, float>("FloatTest")?.Value == 1.1f
            );
        }
        ...
        public void TestBoolLookup(string originalValue, bool expectedParsedValue)
        {
            AddStep(
                "Add config values",
                () => userSource.Configuration.ConfigDictionary["BoolTest"] = originalValue
            );
            AddAssert(
                "Check bool parse lookup",
                () => requester.GetConfig<string, bool>("BoolTest")?.Value == expectedParsedValue
            );
        }
        ...
        public void TestEnumLookup()
        {
            AddStep(
                "Add config values",
                () => userSource.Configuration.ConfigDictionary["Test"] = "Test2"
            );
            AddAssert(
                "Check enum parse lookup",
                () =>
                    requester.GetConfig<LookupType, ValueType>(LookupType.Test)?.Value
                    == ValueType.Test2
            );
        }
        ...
        public void TestLookupFailure()
        {
            AddAssert(
                ...
                () => requester.GetConfig<string, float>("Lookup") == null
            );
        }
        ...
        public void TestLookupNull()
        {
            AddStep(
                "Add config values",
                () => userSource.Configuration.ConfigDictionary["Lookup"] = null
            );
        ...
        public void TestColourLookup()
        {
            AddStep(
                "Add config colour",
                () => userSource.Configuration.CustomColours["Lookup"] = Color4.Red
            );
            AddAssert(
                "Check colour lookup",
                () =>
                    requester
                        .GetConfig<SkinCustomColourLookup, Color4>(
                            new SkinCustomColourLookup("Lookup")
                        )
                        ?.Value == Color4.Red
            );
        }
        ...
        public void TestWrongColourType()
        {
            ...
            AddAssert(
                "perform incorrect lookup",
                () =>
                {
                    try
                    {
                        requester.GetConfig<SkinCustomColourLookup, int>(
                            new SkinCustomColourLookup("Lookup")
                        );
                        return false;
                    }
        ...
        {
            AddAssert(
                "Check retrieved combo colours is skin default colours",
                () =>
                    requester
                        .GetConfig<GlobalSkinColours, IReadOnlyList<Color4>>(
                            GlobalSkinColours.ComboColours
                        )
                        ?.Value?.SequenceEqual(SkinConfiguration.DefaultComboColours) ?? false
            );
        }
        ...
        {
            AddStep(
                "Add custom combo colours to user skin",
                () =>
                    userSource.Configuration.CustomComboColours = new List<Color4>
                    {
            ...
            AddStep(
                "Disallow default colours fallback in beatmap skin",
                () => beatmapSource.Configuration.AllowDefaultComboColoursFallback = false
            );

            AddAssert(
                "Check retrieved combo colours from user skin",
                () =>
                    ...
                    && (
                        requester
                            ...
                            ?.Value?.SequenceEqual(userSource.Configuration.ComboColours) ?? false
                    )
            );
        }
        ...
        {
            AddStep(
                "Set user skin version 2.3",
                () => userSource.Configuration.LegacyVersion = 2.3m
            );
            AddStep(
                "Set beatmap skin version null",
                () => beatmapSource.Configuration.LegacyVersion = null
            );
            AddAssert(
                "Check legacy version lookup",
                () =>
                    requester
        ...
        public void TestSetBeatmapVersionFallsBackToUserSkin()
        {
            ...
            AddStep(
                "Set beatmap skin version null",
                () => beatmapSource.Configuration.LegacyVersion = 1.7m
            );
            AddAssert(
                "Check legacy version lookup",
                () =>
        ...
        public void TestNullBeatmapAndUserVersionFallsBackToLatest()
        {
            AddStep(
                "Set user skin version 2.3",
                () => userSource.Configuration.LegacyVersion = null
            );
            AddStep(
                "Set beatmap skin version null",
                () => beatmapSource.Configuration.LegacyVersion = null
            ...
            AddAssert(
                ...
                () =>
                    requester
                        ...
                        ?.Value == SkinConfiguration.LATEST_VERSION
            );
        }
        ...
        {
            AddStep(
                "Parse skin with no version",
                () =>
                    userSource.Configuration = new LegacySkinDecoder().Decode(
                        new LineBufferedReader(new MemoryStream())
                    )
            );
            AddAssert(
                "Check legacy version lookup",
