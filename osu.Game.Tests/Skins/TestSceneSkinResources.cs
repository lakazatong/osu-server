...
namespace osu.Game.Tests.Skins
{
    ...
    public partial class TestSceneSkinResources : OsuTestScene
    {
        ...
        public void TestRetrieveOggSample()
        {
            ...
            AddAssert(
                "sample is non-null",
                () => skin.GetSample(new SampleInfo(@"sample")) != null
            );
        }
        ...
        public void TestRetrievalWithConflictingFilenames()
        {
            ...
            AddStep(
                "import skin",
                () => skin = importSkinFromArchives(@"conflicting-filenames-skin.osk")
            );
            AddAssert("texture is non-null", () => skin.GetTexture(@"spinner-osu") != null);
            AddAssert(
                "sample is non-null",
                () => skin.GetSample(new SampleInfo(@"spinner-osu")) != null
            );
        }
        ...
        public void TestSampleRetrievalOrder()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    TestSkin testSkin = new TestSkin(
                        ...
                        new ResourceStore<byte[]>(mockResourceStore.Object)
                    );
            ...
            AddAssert(
                "sample lookups were in correct order",
                () =>
                {
                    string[] lookups = lookedUpFileNames
                        .Where(f => f.StartsWith(TestSkin.SAMPLE_NAME, StringComparison.Ordinal))
                        .ToArray();
        ...
        private class TestSkin : Skin
        {
            ...
            public override ISample GetSample(ISampleInfo sampleInfo) =>
                Samples.AsNonNull().Get(SAMPLE_NAME);
        }
    }
}
