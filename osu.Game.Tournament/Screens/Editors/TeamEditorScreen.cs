...
{
    public partial class TeamEditorScreen
        : TournamentEditorScreen<TeamEditorScreen.TeamRow, TournamentTeam>
    {
        ...
        public partial class TeamRow : CompositeDrawable, IModelBacked<TournamentTeam>
        {
            ...
            protected override void LoadComplete()
            {
                ...
                Model.Acronym.BindValueChanged(
                    acronym =>
                    {
                        var teamsWithSameAcronym = ladderInfo
                            .Teams.Where(t => t.Acronym.Value == acronym.NewValue && t != Model)
                            .ToList();
            ...
            private partial class LastYearPlacementSlider : RoundedSliderBar<int>
            {
                public override LocalisableString TooltipText =>
                    Current.Value == 0 ? "N/A" : base.TooltipText;
            }
