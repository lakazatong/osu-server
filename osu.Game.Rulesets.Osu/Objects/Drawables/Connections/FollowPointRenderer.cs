...
namespace osu.Game.Rulesets.Osu.Objects.Drawables.Connections
{
    ...
    /// </summary>
    public partial class FollowPointRenderer
        : PooledDrawableWithLifetimeContainer<FollowPointLifetimeEntry, FollowPointConnection>
    {
        ...
        private readonly List<FollowPointLifetimeEntry> lifetimeEntries =
            new List<FollowPointLifetimeEntry>();
        private readonly Dictionary<HitObject, IBindable> startTimeMap =
            new Dictionary<HitObject, IBindable>();
        ...
        private void addEntry(OsuHitObject hitObject)
        {
            ...
            int index = lifetimeEntries.AddInPlace(
                newEntry,
                Comparer<FollowPointLifetimeEntry>.Create(
                    (e1, e2) =>
                    {
