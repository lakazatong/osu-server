...
namespace osu.Game.Rulesets.Osu.Edit
{
    public partial class OsuGridToolboxGroup : EditorToolboxGroup, IKeyBindingHandler<GlobalAction>
    {
        ...
        /// </summary>
        public BindableFloat StartPositionX { get; } =
            new BindableFloat(OsuPlayfield.BASE_SIZE.X / 2)
            {
                MinValue = 0f,
        ...
        /// </summary>
        public BindableFloat StartPositionY { get; } =
            new BindableFloat(OsuPlayfield.BASE_SIZE.Y / 2)
            {
                MinValue = 0f,
        ...
        /// </summary>
        public BindableFloat GridLinesRotation { get; } =
            new BindableFloat(0f)
            {
                MinValue = -180f,
                MaxValue = 180f,
                Precision = 0.01f,
        ...
        /// </summary>
        public Bindable<Vector2> StartPosition { get; } =
            new Bindable<Vector2>(OsuPlayfield.BASE_SIZE / 2);
        ...
        public Bindable<PositionSnapGridType> GridType { get; } =
            new Bindable<PositionSnapGridType>();
        ...
        public void SetGridFromPoints(Vector2 point1, Vector2 point2)
        {
            ...
            if (!GridLinesRotation.Disabled)
            {
                ...
                GridLinesRotation.Value = normalizeRotation(
        ...
        private void load()
        {
            Children = new Drawable[]
            {
                ...
                spacingSlider = new ExpandableSlider<float> { Current = Spacing, KeyboardStep = 1 },
        ...
        protected override void LoadComplete()
        {
            ...
            StartPositionX.BindValueChanged(
                x =>
                {
            ...
            StartPositionY.BindValueChanged(
                y =>
                {
            ...
            GridLinesRotation.BindValueChanged(
                rotation =>
                {
                    gridLinesRotationSlider.ContractedLabelText = $"R: {rotation.NewValue:#,0.##}";
                    gridLinesRotationSlider.ExpandedLabelText =
                        $"Rotation: {rotation.NewValue:#,0.##}";
                },
                true
            );

            GridType.BindValueChanged(
                v =>
                {
        ...
        public bool OnPressed(KeyBindingPressEvent<GlobalAction> e)
        {
            switch (e.Action)
            {
                case GlobalAction.EditorCycleGridSpacing:
                    Spacing.Value =
                        Spacing.Value * 2 >= max_automatic_spacing
                            ? Spacing.Value / 8
                            : Spacing.Value * 2;
                    return true;

                case GlobalAction.EditorCycleGridType:
                    GridType.Value = (PositionSnapGridType)(
                        ((int)GridType.Value + 1) % Enum.GetValues<PositionSnapGridType>().Length
                    );
                    return true;
            }
