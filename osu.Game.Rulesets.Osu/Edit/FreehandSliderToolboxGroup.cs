...
namespace osu.Game.Rulesets.Osu.Edit
{
    public partial class FreehandSliderToolboxGroup : EditorToolboxGroup
    {
        ...
        public BindableFloat Tolerance { get; } =
            new BindableFloat(1.8f)
            {
                MinValue = 0.05f,
                MaxValue = 2.0f,
                Precision = 0.01f,
        ...
        public BindableFloat CornerThreshold { get; } =
            new BindableFloat(0.4f)
            {
                MinValue = 0.05f,
                MaxValue = 1f,
                Precision = 0.01f,
        ...
        public BindableFloat CircleThreshold { get; } =
            new BindableFloat(0.0015f)
            {
                MinValue = 0f,
                MaxValue = 0.005f,
                Precision = 0.0001f,
        ...
        private void load()
        {
            ...
            {
                toleranceSlider = new ExpandableSlider<int> { Current = displayTolerance },
        ...
        protected override void LoadComplete()
        {
            ...
            displayTolerance.BindValueChanged(
                tolerance =>
                {
                    toleranceSlider.ContractedLabelText = $"C. P. S.: {tolerance.NewValue:N0}";
                    toleranceSlider.ExpandedLabelText =
                        $"Control Point Spacing: {tolerance.NewValue:N0}";
            ...
            displayCornerThreshold.BindValueChanged(
                threshold =>
                {
                    cornerThresholdSlider.ContractedLabelText = $"C. T.: {threshold.NewValue:N0}";
                    cornerThresholdSlider.ExpandedLabelText =
                        $"Corner Threshold: {threshold.NewValue:N0}";
            ...
            displayCircleThreshold.BindValueChanged(
                threshold =>
                {
                    circleThresholdSlider.ContractedLabelText =
                        $"P. C. T.: {threshold.NewValue:N0}";
                    circleThresholdSlider.ExpandedLabelText =
                        $"Perfect Curve Threshold: {threshold.NewValue:N0}";
