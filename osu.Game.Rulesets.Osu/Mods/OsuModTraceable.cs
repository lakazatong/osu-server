...
namespace osu.Game.Rulesets.Osu.Mods
{
    public class OsuModTraceable : ModWithVisibilityAdjustment, IRequiresApproachCircles
    {
        ...
        public override Type[] IncompatibleMods =>
            new[] { typeof(IHidesApproachCircles), typeof(OsuModDepth) };
        ...
        private void applyCirclePieceState(
            DrawableOsuHitObject hitObject,
            IDrawable? hitCircle = null
        )
        {
        ...
        {
            ((PlaySliderBody)slider.Body.Drawable).AccentColour = slider.AccentColour.Value.Opacity(
                0
            );
