...
namespace osu.Game.Overlays.Mods
{
    ...
    /// </summary>
    public partial class BeatmapAttributesDisplay
            ...
            IHasCustomTooltip<AdjustedAttributesTooltip.Data?>
    {
        ...
        private void updateValues() =>
            Scheduler.AddOnce(() =>
            {
                ...
                adjustedDifficulty = ruleset.GetRateAdjustedDisplayDifficulty(
                    adjustedDifficulty,
                    rate
                );
                ...
                circleSizeDisplay.AdjustType.Value = VerticalAttributeDisplay.CalculateEffect(
                    originalDifficulty.CircleSize,
                    adjustedDifficulty.CircleSize
                );
                drainRateDisplay.AdjustType.Value = VerticalAttributeDisplay.CalculateEffect(
                    originalDifficulty.DrainRate,
                    adjustedDifficulty.DrainRate
                );
                approachRateDisplay.AdjustType.Value = VerticalAttributeDisplay.CalculateEffect(
                    originalDifficulty.ApproachRate,
                    adjustedDifficulty.ApproachRate
                );
                overallDifficultyDisplay.AdjustType.Value =
                    VerticalAttributeDisplay.CalculateEffect(
        ...
        public partial class BPMDisplay : RollingCounter<int>
        {
            ...
            protected override LocalisableString FormatCount(int count) =>
                count.ToLocalisableString("0 BPM");
