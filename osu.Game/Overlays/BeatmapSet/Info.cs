...
namespace osu.Game.Overlays.BeatmapSet
{
    public partial class Info : Container
    {
        ...
        public Info()
        {
                ...
                new Container
                {
                    ...
                    Children = new Drawable[]
                    {
                        new Container
                        {
                            ...
                            {
                                Right =
                                    metadata_width + BeatmapSetOverlay.RIGHT_WIDTH + spacing * 2,
                            },
                            Child = new Container
                            {
                                RelativeSizeAxes = Axes.Both,
                        ...
                        new OsuScrollContainer
                        {
                            ...
                            {
                                Right = BeatmapSetOverlay.RIGHT_WIDTH + spacing,
                            },
                            Masking = true,
                        ...
                        new Container
                        {
                            ...
                            Children = new Drawable[]
                            {
                                successRateBackground = new Box { RelativeSizeAxes = Axes.Both },
            ...
            {
                nominators.Metadata = (
                    b.NewValue?.CurrentNominations ?? Array.Empty<BeatmapSetOnlineNomination>(),
                    b.NewValue?.RelatedUsers ?? Array.Empty<APIUser>()
                );
                ...
                genre.Metadata =
                    b.NewValue?.Genre
                    ?? new BeatmapSetOnlineGenre { Id = (int)SearchGenre.Unspecified };
                language.Metadata =
                    b.NewValue?.Language
                    ?? new BeatmapSetOnlineLanguage { Id = (int)SearchLanguage.Unspecified };
            });
        ...
        {
            if (
                Beatmap.Value?.TopTags == null
                || Beatmap.Value.TopTags.Length == 0
                || BeatmapSet.Value?.RelatedTags == null
            )
            {
            ...
            userTags.Metadata = Beatmap
                .Value.TopTags.Select(t =>
                    (topTag: t, relatedTag: tagsById.GetValueOrDefault(t.TagId))
                )
