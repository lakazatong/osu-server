...
namespace osu.Game.Overlays.Chat.ChannelList
{
    public partial class ChannelList : Container
    {
        ...
        public IEnumerable<Channel> Channels =>
            groupFlow
                .Children.OfType<ChannelGroup>()
                .SelectMany(channelGroup => channelGroup.ItemFlow)
                .Select(item => item.Channel);

        public readonly ChannelListing.ChannelListingChannel ChannelListingChannel =
            new ChannelListing.ChannelListingChannel();

        private readonly Dictionary<Channel, ChannelListItem> channelMap =
            new Dictionary<Channel, ChannelListItem>();
        ...
        private void load(OverlayColourProvider colourProvider)
        {
                        ...
                        new SearchContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                new Container
                                {
                                    ...
                                    Child = searchTextBox =
                                        new ChannelSearchTextBox { RelativeSizeAxes = Axes.X },
                                },
                                ...
                                AnnounceChannelGroup = new ChannelGroup(
                                    ChatStrings.ChannelsListTitleANNOUNCE.ToUpper(),
                                    FontAwesome.Solid.Bullhorn,
                                    false
                                ),
                                PublicChannelGroup = new ChannelGroup(
                                    ChatStrings.ChannelsListTitlePUBLIC.ToUpper(),
                                    FontAwesome.Solid.Comments,
                                    false
                                ),
                                selector = new ChannelListItem(ChannelListingChannel),
                                TeamChannelGroup = new ChannelGroup(
                                    ChatStrings.ChannelsListTitleTEAM.ToUpper(),
                                    FontAwesome.Solid.Users,
                                    false
                                ),
                                PrivateChannelGroup = new ChannelGroup(
                                    ChatStrings.ChannelsListTitlePM.ToUpper(),
            ...
            searchTextBox.Current.BindValueChanged(
                _ => groupFlow.SearchTerm = searchTextBox.Current.Value,
                true
            );
            searchTextBox.OnCommit += (_, _) =>
            {
                ...
                var firstMatchingItem = this.ChildrenOfType<ChannelListItem>()
                    .FirstOrDefault(item => item.MatchingFilter);
        ...
        public void ScrollChannelIntoView(Channel channel) =>
            scroll.ScrollIntoView(GetItem(channel));
        ...
        public partial class ChannelGroup : FillFlowContainer
        {
                ...
                Children = new Drawable[]
                {
                    new FillFlowContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            ...
                            new SpriteIcon { Icon = icon, Size = new Vector2(12) },
                        },
                    },
            ...
            public partial class ChannelListItemFlow : FillFlowContainer<ChannelListItem>
            {
                ...
                public override IEnumerable<Drawable> FlowingChildren =>
                    sortByRecent
                        ? base
                            .FlowingChildren.OfType<ChannelListItem>()
                            .OrderByDescending(i => i.Channel.LastMessageId ?? long.MinValue)
                        : base
                            .FlowingChildren.OfType<ChannelListItem>()
                            .OrderBy(i => i.Channel.Name);
            }
            ...
            private void pendingMessageResolved(LocalEchoMessage _, Message __) =>
                ItemFlow.Reflow();
