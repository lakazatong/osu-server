...
namespace osu.Game.Overlays.Comments
{
    public partial class VotePill : LoadingButton, IHasAccentColour
    {
        ...
        protected override void LoadComplete()
        {
            ...
            isVoted.BindValueChanged(
                voted =>
                    Background.Colour = voted.NewValue ? AccentColour : colourProvider.Background6,
                true
            );
        ...
        private void onAction()
        {
            ...
            request = new CommentVoteRequest(
                comment.Id,
                isVoted.Value ? CommentVoteAction.UnVote : CommentVoteAction.Vote
            );
                ...
                Children = new Drawable[]
                {
                    borderContainer = new CircularContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            ...
                            hoverLayer = new Box { RelativeSizeAxes = Axes.Both, Alpha = 0 },
                        },
                    },
