...
namespace osu.Game.Screens.Edit.Setup
{
    ...
    public partial class FormBeatmapFileSelector : FormFileSelector
    {
        ...
        public FormBeatmapFileSelector(
            bool beatmapHasMultipleDifficulties,
            params string[] handledExtensions
        )
        ...
        protected override FileChooserPopover CreatePopover(
        ...
        private partial class BeatmapFileChooserPopover : FileChooserPopover
        {
            ...
            public BeatmapFileChooserPopover(
                string[] handledExtensions,
                Bindable<FileInfo?> current,
                string? chooserPath,
                bool beatmapHasMultipleDifficulties
            ...
            {
                Add(
                    selectApplicationScopeContainer = new InputBlockingContainer
                    {
                        Alpha = 0f,
                                    ...
                                    new FillFlowContainer
                                    {
                                        ...
                                        Children = new Drawable[]
                                        {
                                            new OsuSpriteText
                                            {
                                                ...
                                                Origin = Anchor.Centre,
                                                Text =
                                                    EditorSetupStrings.ApplicationScopeSelectionTitle,
