...
namespace osu.Game.Beatmaps.Timing
{
    public class BreakPeriod : IEquatable<BreakPeriod>, IComparable<BreakPeriod>
    {
        ...
        /// </summary>
        public const double MIN_GAP_DURATION =
            GAP_BEFORE_BREAK + MIN_BREAK_DURATION + GAP_AFTER_BREAK;
        ...
        public bool Contains(double time) =>
            time >= StartTime && time <= EndTime - BreakOverlay.BREAK_FADE_DURATION;

        public bool Intersects(BreakPeriod other) =>
