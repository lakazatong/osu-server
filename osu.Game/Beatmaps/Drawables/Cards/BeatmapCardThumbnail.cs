...
namespace osu.Game.Beatmaps.Drawables.Cards
{
    public partial class BeatmapCardThumbnail : Container
    {
        ...
        public BeatmapCardThumbnail(
            ...
            IBeatmapSetOnlineInfo onlineInfo
        )
        {
        ...
        protected override void Update()
        {
            ...
            progress.Size = new Vector2(
                50 * playButton.DrawWidth / (BeatmapCardNormal.HEIGHT - BeatmapCard.CORNER_RADIUS)
            );
        }
        ...
        private void updateState()
        {
            ...
            background.FadeColour(
                colourProvider.Background6.Opacity(shouldDim ? 0.6f : 0f),
