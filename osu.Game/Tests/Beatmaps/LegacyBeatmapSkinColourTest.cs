...
namespace osu.Game.Tests.Beatmaps
{
    public abstract partial class LegacyBeatmapSkinColourTest : ScreenTestScene
    {
        ...
        protected void PrepareBeatmap(Func<WorkingBeatmap> createBeatmap) =>
            AddStep("prepare beatmap", () => testBeatmap = createBeatmap());

        protected void ConfigureTest(
            bool useBeatmapSkin,
            bool useBeatmapColours,
        ...
        {
            AddStep(
                $"{(beatmapSkins ? "enable" : "disable")} beatmap skins",
                () =>
                {
            ...
            AddStep(
                $"{(beatmapColours ? "enable" : "disable")} beatmap colours",
                () =>
                {
        ...
        protected virtual ExposedPlayer CreateTestPlayer(bool userHasCustomColours) =>
            new ExposedPlayer(userHasCustomColours);
        ...
        protected class CustomSkinWorkingBeatmap : ClockBackedTestWorkingBeatmap
        {
            ...
            protected internal override ISkin GetSkin() =>
                new TestBeatmapSkin(BeatmapInfo, HasColours);
        }
        ...
        protected class TestBeatmapSkin : LegacyBeatmapSkin
        {
                ...
                : base(beatmapInfo, null)
            {
                if (hasColours)
                {
                    ...
                    Configuration.CustomColours.Add(
                        "HyperDashAfterImage",
                        HYPER_DASH_AFTER_IMAGE_COLOUR
                    );
