...
namespace osu.Game.Localisation
{
    public static class FirstRunSetupBeatmapScreenStrings
    {
        ...
        public static LocalisableString Header =>
            new TranslatableString(getKey(@"header"), @"Obtaining Beatmaps");
        ...
        /// </summary>
        public static LocalisableString TutorialButton =>
            new TranslatableString(getKey(@"tutorial_button"), @"Get the osu! tutorial");

        /// <summary>
        /// "To get you started, we have some recommended beatmaps."
        /// </summary>
        public static LocalisableString BundledDescription =>
            new TranslatableString(
                getKey(@"bundled_description"),
                @"To get you started, we have some recommended beatmaps."
            );
        ...
        /// </summary>
        public static LocalisableString BundledButton =>
            new TranslatableString(getKey(@"bundled_button"), @"Get recommended beatmaps");
        ...
        public static LocalisableString DownloadingInBackground =>
            new TranslatableString(
                getKey(@"downloading_in_background"),
                @"Beatmaps will be downloaded in the background. You can continue with setup while this happens!"
            );
        ...
        /// </summary>
        public static LocalisableString CurrentlyLoadedBeatmaps(int beatmaps) =>
            new TranslatableString(
                getKey(@"currently_loaded_beatmaps"),
                @"You currently have {0} beatmap(s) loaded!",
                beatmaps
            );
