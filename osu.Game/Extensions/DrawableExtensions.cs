...
namespace osu.Game.Extensions
{
    public static class DrawableExtensions
    {
        ...
        public static void Shake(
            ...
            double shakeDuration = 80,
            float shakeMagnitude = 8,
        ...
        )
        {
            ...
            var sequence = target
                .MoveToX(shakeMagnitude, shakeDuration / 2, Easing.OutSine)
                .Then()
                .MoveToX(-shakeMagnitude, shakeDuration, Easing.InOutSine)
                .Then();
        ...
        public static Vector2 ScreenSpaceDeltaToParentSpace(
