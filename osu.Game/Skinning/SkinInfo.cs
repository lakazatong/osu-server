...
namespace osu.Game.Skinning
{
    ...
    public class SkinInfo
        : RealmObject,
            ...
            ISoftDelete
    {
        internal static readonly Guid TRIANGLES_SKIN = new Guid(
        ...
        internal static readonly Guid ARGON_PRO_SKIN = new Guid(
            "9FC9CF5D-0F16-4C71-8256-98868321AC43"
        );
        internal static readonly Guid CLASSIC_SKIN = new Guid(
            "81F02CD3-EEC6-4865-AC23-FAE26A386187"
        );
        internal static readonly Guid RANDOM_SKIN = new Guid(
