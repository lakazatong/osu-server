...
namespace osu.Game.Scoring
{
    public static class ScoreInfoExtensions
    {
        ...
        public static string GetDisplayTitle(this IScoreInfo scoreInfo) =>
            $"{scoreInfo.User.Username} playing {scoreInfo.Beatmap?.GetDisplayTitle() ?? "unknown"}";
        ...
        public static IEnumerable<ScoreInfo> OrderByTotalScore(
        ...
        public static int GetMaximumAchievableCombo(this ScoreInfo score) =>
            score.MaximumStatistics.Where(kvp => kvp.Key.AffectsCombo()).Sum(kvp => kvp.Value);
    }
}
