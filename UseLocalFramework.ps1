...
dotnet sln $SLN add ../osu-framework-server/osu.Framework/osu.Framework.csproj `
    ../osu-framework-server/osu.Framework.NativeLibs/osu.Framework.NativeLibs.csproj `
    ../osu-framework-server/osu.Framework.Android/osu.Framework.Android.csproj `
    ../osu-framework-server/osu.Framework.iOS/osu.Framework.iOS.csproj;

dotnet add $GAME_CSPROJ reference ../osu-framework-server/osu.Framework/osu.Framework.csproj;
dotnet add $ANDROID_PROPS reference ../osu-framework-server/osu.Framework.Android/osu.Framework.Android.csproj;
dotnet add $IOS_PROPS reference ../osu-framework-server/osu.Framework.iOS/osu.Framework.iOS.csproj;
...
$SLNF.solution.projects += ("../osu-framework-server/osu.Framework/osu.Framework.csproj", "../osu-framework-server/osu.Framework.NativeLibs/osu.Framework.NativeLibs.csproj")
...
$SLNF.solution.projects += ("../osu-framework-server/osu.Framework/osu.Framework.csproj", "../osu-framework-server/osu.Framework.NativeLibs/osu.Framework.NativeLibs.csproj", "../osu-framework-server/osu.Framework.Android/osu.Framework.Android.csproj")
ConvertTo-Json $SLNF | Out-File $TMP -Encoding UTF8
Move-Item -Path $TMP -Destination "osu.Android.slnf" -Force

$SLNF=Get-Content "osu.iOS.slnf" | ConvertFrom-Json
$SLNF.solution.projects += ("../osu-framework-server/osu.Framework/osu.Framework.csproj", "../osu-framework-server/osu.Framework.NativeLibs/osu.Framework.NativeLibs.csproj", "../osu-framework-server/osu.Framework.iOS/osu.Framework.iOS.csproj")
ConvertTo-Json $SLNF | Out-File $TMP -Encoding UTF8
