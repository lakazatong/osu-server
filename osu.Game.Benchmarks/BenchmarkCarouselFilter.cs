...
namespace osu.Game.Benchmarks
{
    public class BenchmarkCarouselFilter : BenchmarkTest
    {
        ...
        public override void SetUp()
        {
            ...
            criteria2 = new FilterCriteria { Ruleset = new RulesetInfo { ShortName = "catch" } };
            ...
            {
                Creator = new FilterCriteria.OptionalTextFilter
                {
                    SearchTerm = "the author AND then something else",
                },
            };
