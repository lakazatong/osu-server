...
namespace osu.Game.Rulesets.Mania.Skinning.Legacy
{
    public partial class LegacyManiaJudgementPiece : CompositeDrawable, IAnimatableJudgement
    {
        ...
        private void onDirectionChanged()
        {
            ...
            float scorePosition =
                skin.GetManiaSkinConfig<float>(
                    LegacyManiaSkinConfigurationLookups.ScorePosition
                )?.Value ?? 0;

            float hitPositionFromTop =
                480f * LegacyManiaSkinConfiguration.POSITION_SCALE_FACTOR - hitPosition;
            ...
            if (scorePosition > hitPositionFromTop / 2f)
            {
                ...
                Y =
                    direction.Value == ScrollingDirection.Up
                        ? hitPositionFromTop - scorePosition
                        : scorePosition - hitPositionFromTop;
            }
            else
            {
                Anchor =
        ...
        public void PlayAnimation()
        {
            ...
            this.FadeInFromZero(20, Easing.Out).Then().Delay(160).FadeOutFromOne(40, Easing.In);
