                ...
                () =>
                    InputManager.MoveMouseTo(
                        playfield.ScreenSpaceDrawQuad.Centre
                            + new Vector2(playfield.ScreenSpaceDrawQuad.Width * 0.01f, 0)
                    )
            );
        ...
        public void TestHitCircleSnapsToSliderEnd()
        {
            ...
            AddStep(
                ...
                () =>
                    InputManager.MoveMouseTo(
                        playfield.ScreenSpaceDrawQuad.Centre
                            + new Vector2(playfield.ScreenSpaceDrawQuad.Width * 0.225f, 0)
                    )
            );
            ...
            AddStep(
                ...
                () =>
                    InputManager.MoveMouseTo(
                        playfield.ScreenSpaceDrawQuad.Centre
                            + new Vector2(playfield.ScreenSpaceDrawQuad.Width * 0.205f, 0)
                    )
            );
        ...
        public void TestSecondCircleInSelectionAlsoSnaps()
        {
            ...
            AddStep(
                ...
                () =>
                    InputManager.MoveMouseTo(
                        playfield.ScreenSpaceDrawQuad.Centre
                            + new Vector2(playfield.ScreenSpaceDrawQuad.Width * 0.2f, 0)
                    )
            );
            AddStep("place second object", () => InputManager.Click(MouseButton.Left));
            ...
            AddStep(
                ...
                () =>
                    InputManager.MoveMouseTo(
                        playfield.ScreenSpaceDrawQuad.Centre
                            + new Vector2(0, playfield.ScreenSpaceDrawQuad.Width * 0.2f)
                    )
            );
            ...
            AddStep(
                "move mouse slightly off centre",
                () =>
                    InputManager.MoveMouseTo(
                        playfield.ScreenSpaceDrawQuad.Centre
                            + new Vector2(playfield.ScreenSpaceDrawQuad.Width * 0.01f, 0)
            ...
            AddStep(
                ...
                () =>
                    InputManager.MoveMouseTo(
                        playfield.ScreenSpaceDrawQuad.Centre
                            + new Vector2(
                                playfield.ScreenSpaceDrawQuad.Width * -0.21f,
                                playfield.ScreenSpaceDrawQuad.Width * 0.205f
                            )
                    )
            );

            AddAssert(
                "object 2 snapped to 1",
                () =>
                {
                    var objects = EditorBeatmap.HitObjects;
