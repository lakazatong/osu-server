...
namespace osu.Game.Rulesets.Osu.Tests.Editor
{
    public partial class TestSceneHitCircleSelectionBlueprint : SelectionBlueprintTestScene
    {
        ...
        {
            AddAssert(
                "blueprint positioned over hitobject",
                () => blueprint.CirclePiece.Position == hitCircle.Position
            );
        }
        ...
        public void TestStackedHitObject()
        {
            ...
            AddAssert(
                "blueprint positioned over hitobject",
                () => blueprint.CirclePiece.Position == hitCircle.StackedPosition
            );
        }
