    ...
    public partial class TestSceneOsuReverseSelection : TestSceneOsuEditor
    {
        ...
        public void TestReverseSelectionTwoCircles()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    var circle1 = new HitCircle { StartTime = 0, Position = new Vector2(208, 240) };
            ...
            AddAssert(
                "new combo positions preserved",
                getObjectNewCombos,
                () => Is.EqualTo(newCombos)
            );
        }
        ...
        public void TestReverseSelectionCircleAndSlider()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    var circle = new HitCircle { StartTime = 0, Position = new Vector2(208, 240) };
            ...
            AddAssert(
                "Slider head is at slider tail",
                () =>
                    Vector2.Distance(
                        EditorBeatmap.HitObjects.OfType<Slider>().ElementAt(0).Position,
                        sliderTailOldPosition
                    ) < 1
            );

            AddAssert(
                "Slider tail is at slider head",
                () =>
                    Vector2.Distance(
                        EditorBeatmap.HitObjects.OfType<Slider>().ElementAt(0).EndPosition,
                        sliderHeadOldPosition
                    ) < 1
            );
        }
        ...
        public void TestReverseSelectionTwoCombos()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    var circle1 = new HitCircle { StartTime = 0, Position = new Vector2(216, 240) };
                    var circle2 = new HitCircle
                    {
                        StartTime = 200,
        ...
        private IEnumerable<OsuHitObject> getObjects() =>
            EditorBeatmap.HitObjects.OfType<OsuHitObject>();
