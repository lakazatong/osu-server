...
namespace osu.Game.Rulesets.Osu.Tests.Editor.Checks
{
    ...
    public class CheckLowDiffOverlapsTest
    {
        ...
        private void assertShouldProbablyOverlap(IBeatmap beatmap, int count = 1)
        {
            ...
            Assert.That(
                issues.All(issue =>
                    issue.Template is CheckLowDiffOverlaps.IssueTemplateShouldProbablyOverlap
                )
            );
        }
        ...
        private void assertShouldOverlap(IBeatmap beatmap, int count = 1)
        {
            ...
            Assert.That(
                issues.All(issue =>
                    issue.Template is CheckLowDiffOverlaps.IssueTemplateShouldOverlap
                )
            );
        }
        ...
        private void assertShouldNotOverlap(IBeatmap beatmap, int count = 1)
        {
            ...
            Assert.That(
                issues.All(issue =>
                    issue.Template is CheckLowDiffOverlaps.IssueTemplateShouldNotOverlap
                )
            );
        }
    }
