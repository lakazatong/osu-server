...
namespace osu.Game.Rulesets.Osu.Tests.Editor.Checks
{
    ...
    public class CheckTimeDistanceEqualityTest
    {
                ...
                new Beatmap<HitObject>
                {
                    HitObjects = new List<HitObject>
                    {
                        ...
                        new HitCircle
                        {
                            ...
                            Position = new Vector2(50, 0),
                            StackHeight = 4,
                        }, // Ends up far from (50; 0), causing irregular spacing.
            ...
            assertOk(
                new Beatmap<HitObject>
                {
                    HitObjects = new List<HitObject>
                    {
                        ...
                        {
                            StartTime = 1000,
                            Position = new Vector2(50 + 50 * multiplier, 0),
                        },
                        ...
                        new HitCircle
                        {
                            ...
                            Position = new Vector2(
                                50 + 50 * multiplier + 50 * multiplier * multiplier,
                                0
                            ),
                        },
                    },
        ...
        public void TestCirclesQuicklyChanging()
        {
            ...
            Assert.That(
                issues.First().Template
                    is CheckTimeDistanceEquality.IssueTemplateIrregularSpacingWarning
            );
            Assert.That(
                issues.Last().Template
                ...
                new Beatmap<HitObject>
                {
                    HitObjects = new List<HitObject>
                    {
                        ...
                        getSliderMock(
                            ...
                            endPosition: new Vector2(150, 0)
                        ).Object,
                        getSliderMock(
                            startTime: 2000,
                            endTime: 2500,
                            startPosition: new Vector2(200, 0),
                            endPosition: new Vector2(250, 0)
                        ).Object,
                ...
                new Beatmap<HitObject>
                {
                    HitObjects = new List<HitObject>
                    {
                        ...
                        getSliderMock(
                            startTime: 2000,
                            endTime: 2500,
                            startPosition: new Vector2(250, 0),
                            endPosition: new Vector2(300, 0)
                        ).Object, // Twice the spacing.
                        new HitCircle { StartTime = 2500, Position = new Vector2(300, 0) },
                    },
                }
            );
        ...
        private Mock<Slider> getSliderMock(
            double startTime,
            double endTime,
        ...
        private void assertWarning(IBeatmap beatmap, int count = 1)
        {
            ...
            Assert.That(
                issues.All(issue =>
                    issue.Template is CheckTimeDistanceEquality.IssueTemplateIrregularSpacingWarning
                )
            );
        }
        ...
        private void assertProblem(IBeatmap beatmap, int count = 1)
        {
            ...
            Assert.That(
                issues.All(issue =>
                    issue.Template is CheckTimeDistanceEquality.IssueTemplateIrregularSpacingProblem
                )
            );
        }
    }
