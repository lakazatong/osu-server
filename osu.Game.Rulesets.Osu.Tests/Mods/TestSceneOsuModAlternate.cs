...
namespace osu.Game.Rulesets.Osu.Tests.Mods
{
    public partial class TestSceneOsuModAlternate : OsuModTestScene
    {
        ...
        /// </summary>
        [Test]
        public void TestInputSingularAtIntro() =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new OsuModAlternate(),
        ...
        /// </summary>
        [Test]
        public void TestInputSingularWithBreak([Values] bool pressBeforeSecondObject) =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new OsuModAlternate(),
                    ...
                    CreateBeatmap = () =>
                        new Beatmap
                        {
                            Breaks = { new BreakPeriod(500, 2000) },
                            HitObjects = new List<HitObject>
                            {
                                new HitCircle { StartTime = 500, Position = new Vector2(100) },
                                new HitCircle
