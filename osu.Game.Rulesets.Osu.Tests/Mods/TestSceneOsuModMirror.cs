...
namespace osu.Game.Rulesets.Osu.Tests.Mods
{
    ...
    {
        [Test]
        public void TestCorrectReflections(
            [Values] OsuModMirror.MirrorType type,
            [Values] bool withStrictTracking
        ) =>
            CreateModTest(
                new ModTestData
                {
                    ...
                    PassCondition = () =>
                    {
                        ...
                        return Precision.AlmostEquals(
                                playfield.ToLocalSpace(
                                    slider.HeadCircle.ScreenSpaceDrawQuad.Centre
                                ),
                                slider.HitObject.Position
                            )
                            && Precision.AlmostEquals(
                                playfield.ToLocalSpace(
                                    slider.TailCircle.ScreenSpaceDrawQuad.Centre
                                ),
                                slider.HitObject.Position
                            )
                            && Precision.AlmostEquals(
                                playfield.ToLocalSpace(
                                    slider
                                        .NestedHitObjects.OfType<DrawableSliderRepeat>()
                                        .Single()
                            ...
                            && Precision.AlmostEquals(
                                playfield.ToLocalSpace(
                                    slider
                                        .NestedHitObjects.OfType<DrawableSliderTick>()
                                        .First()
                                        .ScreenSpaceDrawQuad.Centre
                                ),
