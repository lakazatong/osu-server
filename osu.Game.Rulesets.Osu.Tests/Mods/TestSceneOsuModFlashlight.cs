...
namespace osu.Game.Rulesets.Osu.Tests.Mods
{
    public partial class TestSceneOsuModFlashlight : OsuModTestScene
    {
        ...
        [TestCase(120)]
        [TestCase(1200)]
        public void TestFollowDelay(double followDelay) =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new OsuModFlashlight { FollowDelay = { Value = followDelay } },
                    PassCondition = () => true,
                }
            );
        ...
        public void TestSizeMultiplier(float sizeMultiplier) =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new OsuModFlashlight { SizeMultiplier = { Value = sizeMultiplier } },
                    PassCondition = () => true,
                }
            );
        ...
        public void TestComboBasedSize([Values] bool comboBasedSize) =>
            CreateModTest(
                new ModTestData
                {
                    Mod = new OsuModFlashlight { ComboBasedSize = { Value = comboBasedSize } },
                    PassCondition = () => true,
                }
            );
        ...
        public void TestPlayfieldBasedSize()
        {
            ...
            CreateModTest(
                new ModTestData
                {
                    ...
                    PassCondition = () =>
                    {
                        var flashlightOverlay = Player
                            .DrawableRuleset.Overlays.ChildrenOfType<ModFlashlight<OsuHitObject>.Flashlight>()
                            .First();

                        return Precision.AlmostEquals(
                            mod.DefaultFlashlightSize * .5f,
                            flashlightOverlay.GetSize()
                        );
                    },
                }
            );
