    ...
    public partial class TestSceneAccuracyHeatmap : OsuManualInputManagerTestScene
    {
        ...
        public void Setup() =>
            Schedule(() =>
            {
                ...
                Children = new[]
                {
                    ...
                    object2 = new BorderCircle { Position = new Vector2(100, 300) },
                    accuracyHeatmap = new TestAccuracyHeatmap(
                        new ScoreInfo
                        {
                    ...
                    automaticAdditionDelegate = Scheduler.AddDelayed(
                        () =>
                        {
                            var randomPos = new Vector2(
                                RNG.NextSingle(
                                    object1.DrawPosition.X - object1.DrawSize.X / 2,
                                    object1.DrawPosition.X + object1.DrawSize.X / 2
                                ),
                                RNG.NextSingle(
                                    object1.DrawPosition.Y - object1.DrawSize.Y / 2,
                                    object1.DrawPosition.Y + object1.DrawSize.Y / 2
                                )
                            );
                            ...
                            accuracyHeatmap.AddPoint(
                                object2.Position,
                                object1.Position,
                                randomPos,
                                RNG.NextSingle(10, 500)
                            );
        ...
        protected override bool OnMouseDown(MouseDownEvent e)
        {
            accuracyHeatmap.AddPoint(
                object2.Position,
                object1.Position,
                background.ToLocalSpace(e.ScreenSpaceMouseDownPosition),
                50
            );
            return true;
        }
